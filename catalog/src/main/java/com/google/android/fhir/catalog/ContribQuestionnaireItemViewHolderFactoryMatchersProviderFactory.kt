...
import com.google.android.fhir.datacapture.contrib.views.barcode.timeselector.TimePickerViewHolderFactory
...
object ContribQuestionnaireItemViewHolderFactoryMatchersProviderFactory :
  ...
  const val TIME_WIDGET_PROVIDER = "time-widget-provider"
      ...
      TIME_WIDGET_PROVIDER ->
        object : QuestionnaireFragment.QuestionnaireItemViewHolderFactoryMatchersProvider() {
          override fun get():
            ...
            return listOf(
              QuestionnaireFragment.QuestionnaireItemViewHolderFactoryMatcher(
                factory = TimePickerViewHolderFactory,
                matches = TimePickerViewHolderFactory::matcher,
              )
            )
          }
        }
