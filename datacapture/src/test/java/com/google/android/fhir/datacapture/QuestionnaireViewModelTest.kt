...
class QuestionnaireViewModelTest(
  ...
  @Test
  fun questionnaireIsPaginated_goToNextAndPreviousPage_pageFlowStateShouldChange() = runBlocking {
    val paginationExtension =
      Extension().apply {
        url = EXTENSION_ITEM_CONTROL_URL
        setValue(CodeableConcept(Coding().apply { code = "page" }))
    ...
    assertThat(viewModel.pageFlow.value)
      .isEqualTo(QuestionnairePagination(currentPageIndex = 1, lastPageIndex = 1))
  ...
  @Test
  fun questionnaire_variableExtensionRootLevel_applyVariableValueToOtherRootVariables() =
      runBlocking {
    val questionnaire =
      Questionnaire().apply {
        addExtension().apply {
  ...
  @Test
  fun questionnaire_variableExtensionGroupItemLevel_applyVariableValueToNestedItem() = runBlocking {
    val questionnaire =
      Questionnaire().apply {
        id = "a-questionnaire"
        addItem(
