...
class ResourceMapperTest {
  ...
  fun createQuestionnaireResponse() {
    ...
    assertThat((questionnaireResponse[0].answer[0].value as Coding).code).isEqualTo("male")
    assertThat((questionnaireResponse[1].answer[0].value as Coding).code).isEqualTo("south-africa")
    assertThat((questionnaireResponse[2].item[0].item[0].answer[0].value as IntegerType).value)
      .isEqualTo(0)
    assertThat((questionnaireResponse[3].answer[0].value as BooleanType).booleanValue())
      .isEqualTo(true)
  }
}
