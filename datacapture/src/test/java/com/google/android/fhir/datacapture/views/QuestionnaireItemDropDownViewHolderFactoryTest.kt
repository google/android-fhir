...
class QuestionnaireItemDropDownViewHolderFactoryTest {
  ...
  fun shouldPopulateDropDown() {
    ...
    assertThat(selectedItem.answerOptionImage).isEqualTo(null)
  }

  @Test
  fun shouldPopulateDropDownWithImageInItemAnswerMediaExtension() {
    val answerOption =
      Questionnaire.QuestionnaireItemAnswerOptionComponent().apply {
    ...
    assertThat(selectedItem.answerOptionString).isEqualTo("Test Code")
    assertThat(selectedItem.answerOptionImage).isNotNull()
  }
