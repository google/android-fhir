...
class ResourceMapperHAPITest {
    ...
    fun extract() {
        ...
        val uriTestQuestionnaire = iParser.parseResource(org.hl7.fhir.r4.model.Questionnaire::class.java,
                questionnaireJson) as org.hl7.fhir.r4.model.Questionnaire
        val uriTestQuestionnaireResponse = iParser.parseResource(org.hl7.fhir.r4.model.QuestionnaireResponse::class.java,
                questionnaireResponseJson) as org.hl7.fhir.r4.model.QuestionnaireResponse

        val patient = ResourceMapperHAPI.extract(uriTestQuestionnaire,
                uriTestQuestionnaireResponse)

        assertThat((patient as Patient).birthDate).isEqualTo(
                Date(1609448400000)
        )
