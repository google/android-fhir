 ...
 * updated
 *
 * @param modified whether the user has interacted with the questionnaire item (when `onAnswerChanged`
 * triggers). This is to avoid an influx of validation errors when the user first opens the questionnaire.
 */
