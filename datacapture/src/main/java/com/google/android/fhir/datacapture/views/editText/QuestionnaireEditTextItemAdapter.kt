...
emptyList()
) : ListAdapter<QuestionnaireItemViewItem, QuestionnaireEditTextItemAdapter.QuestionnaireEditTextItemViewHolder>(DiffCallback) {
    ...
    val isSingleLine: Boolean, override var questionnaireItemViewItem: QuestionnaireItemViewItem,
        ...
        private var textInputEditText: TextInputEditText = itemView.findViewById(R.id.text_input_edit_text)
     ...
     */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuestionnaireEditTextItemViewHolder {
        val inflater = LayoutInflater.from(parent.context).inflate(R.layout.questionnaire_item_edit_text_view_row, parent, false)
        return QuestionnaireEditTextItemViewHolder(inflater.rootView, rawInputType, isSingleLine, currentList.first())
    }
