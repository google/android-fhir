                        ...
                        object : FragmentResultListener {
                            ...
                            override fun onFragmentResult(requestKey: String, result: Bundle) {
                                ...
                                textInputEditText.setText(
                                    zonedDateTime.format(LOCAL_DATE_FORMATTER)
                                )

                                val date = Date.newBuilder()
                                    .setValueUs(
                                        zonedDateTime.toEpochSecond() *
                                            NUMBER_OF_MICROSECONDS_PER_SECOND
                                    )
            ...
            override fun bind(questionnaireItemViewItem: QuestionnaireItemViewItem) {
                ...
                textInputEditText.setText(
                    questionnaireItemViewItem.singleAnswerOrNull?.value?.date?.let {
                        Instant
                            .ofEpochMilli(it.valueUs / NUMBER_OF_MICROSECONDS_PER_MILLISECOND)
