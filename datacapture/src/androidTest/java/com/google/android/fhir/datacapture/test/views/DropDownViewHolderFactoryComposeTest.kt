...
import com.google.android.fhir.datacapture.views.components.CLEAR_TEXT_ICON_BUTTON_TAG
import com.google.android.fhir.datacapture.views.components.DROP_DOWN_ANSWER_MENU_ITEM_TAG
import com.google.android.fhir.datacapture.views.components.DROP_DOWN_TEXT_FIELD_LEADING_ICON_TAG
...
class DropDownViewHolderFactoryComposeTest {
  @get:Rule
  ...
  @Test
  fun shouldSetImageToAutoCompleteTextViewOnItemSelection() {
    var answerHolder: List<QuestionnaireResponse.QuestionnaireResponseItemAnswerComponent>? = null
    val questionnaireViewItem =
      QuestionnaireViewItem(
        createAnswerOptions(
    ...
    composeTestRule
      .onNodeWithTag(DROP_DOWN_TEXT_FIELD_LEADING_ICON_TAG, useUnmergedTree = true)
      .assertIsDisplayed()
  }
  ...
  fun shouldReturnFilteredDropDownMenuItems() {
    ...
    composeTestRule.onNodeWithTag(DROP_DOWN_TEXT_FIELD_TAG).performTextReplacement("Coding")
  ...
  fun shouldReturnFilteredWithNoResultsDropDownMenuItems() {
    ...
    composeTestRule.onNodeWithTag(DROP_DOWN_TEXT_FIELD_TAG).performTextReplacement("Division")
