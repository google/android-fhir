          ...
          val answerValue =
            when (answerOption.value) {
              is Questionnaire.Item.AnswerOption.Value.Integer ->
                IntegerAnswerValue(
                  value =
                    (answerOption.value as Questionnaire.Item.AnswerOption.Value.Integer).value,
                )
              is Questionnaire.Item.AnswerOption.Value.Coding ->
                QuestionnaireResponse.Item.Answer.Value.Coding(
                  value =
                    (answerOption.value as Questionnaire.Item.AnswerOption.Value.Coding).value,
                )
              is Questionnaire.Item.AnswerOption.Value.Date ->
                QuestionnaireResponse.Item.Answer.Value.Date(
                  value = (answerOption.value as Questionnaire.Item.AnswerOption.Value.Date).value,
                )
              is Questionnaire.Item.AnswerOption.Value.Reference ->
                QuestionnaireResponse.Item.Answer.Value.Reference(
                  value =
                    (answerOption.value as Questionnaire.Item.AnswerOption.Value.Reference).value,
                )
              is Questionnaire.Item.AnswerOption.Value.String ->
                QuestionnaireResponse.Item.Answer.Value.String(
                  value =
                    (answerOption.value as Questionnaire.Item.AnswerOption.Value.String).value,
                )
              is Questionnaire.Item.AnswerOption.Value.Time ->
                QuestionnaireResponse.Item.Answer.Value.Time(
                  value = (answerOption.value as Questionnaire.Item.AnswerOption.Value.Time).value,
                )
            }

          questionnaireViewItem.setAnswer(
            QuestionnaireResponse.Item.Answer(value = answerValue),
          )
        } else {
