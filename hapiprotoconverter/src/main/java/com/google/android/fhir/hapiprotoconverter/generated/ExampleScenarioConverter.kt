...
public object ExampleScenarioConverter {
  ...
  public fun org.hl7.fhir.r4.model.ExampleScenario.ExampleScenarioActorComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.ExampleScenario.ExampleScenarioInstanceComponent.toProto():
    ...
    .setResourceType(ExampleScenario.Instance.ResourceTypeCode.newBuilder().setValue(ResourceTypeCode.Value.valueOf(resourceType.toCode().replace("-",
        "_").toUpperCase())).build())
    .setName(nameElement.toProto())
    .setDescription(descriptionElement.toProto())
  ...
  public fun org.hl7.fhir.r4.model.ExampleScenario.ExampleScenarioProcessComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.ExampleScenario.ExampleScenarioProcessStepComponent.toProto():
  ...
  public fun ExampleScenario.Actor.toHapi():
  ...
  public fun ExampleScenario.Instance.toHapi():
    ...
    hapiValue.setResourceType(org.hl7.fhir.r4.model.ExampleScenario.FHIRResourceType.valueOf(resourceType.value.name.replace("_","")))
    hapiValue.setNameElement(name.toHapi())
    hapiValue.setDescriptionElement(description.toHapi())
  ...
  public fun ExampleScenario.Instance.Version.toHapi():
  ...
  public fun ExampleScenario.Instance.ContainedInstance.toHapi():
  ...
  public fun ExampleScenario.Process.toHapi():
  ...
  public fun ExampleScenario.Process.Step.toHapi():
  ...
  public fun ExampleScenario.Process.Step.Operation.toHapi():
  ...
  public fun ExampleScenario.Process.Step.Alternative.toHapi():
