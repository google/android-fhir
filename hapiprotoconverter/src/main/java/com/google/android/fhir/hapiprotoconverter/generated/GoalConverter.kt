...
public object GoalConverter {
  public fun Goal.StartX.goalStartToHapi(): Type {
  ...
  public fun Goal.Target.DetailX.goalTargetDetailToHapi(): Type {
  ...
  public fun Goal.Target.DueX.goalTargetDueToHapi(): Type {
    if (this.getDate() != Date.newBuilder().defaultInstanceForType ) {
      return (this.getDate()).toHapi()
    }
  ...
  public fun org.hl7.fhir.r4.model.Goal.GoalTargetComponent.toProto(): Goal.Target {
  ...
  public fun Goal.Target.toHapi(): org.hl7.fhir.r4.model.Goal.GoalTargetComponent {
