...
public object DeviceDefinitionConverter {
  public fun DeviceDefinition.ManufacturerX.deviceDefinitionManufacturerToHapi(): Type {
  ...
  public fun org.hl7.fhir.r4.model.DeviceDefinition.DeviceDefinitionDeviceNameComponent.toProto():
    ...
    .setType(DeviceDefinition.DeviceName.TypeCode.newBuilder().setValue(DeviceNameTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
    .build()
    return protoValue
  }
  ...
  public fun org.hl7.fhir.r4.model.DeviceDefinition.DeviceDefinitionCapabilityComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.DeviceDefinition.DeviceDefinitionPropertyComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.DeviceDefinition.DeviceDefinitionMaterialComponent.toProto():
  ...
  public fun DeviceDefinition.UdiDeviceIdentifier.toHapi():
  ...
  public fun DeviceDefinition.DeviceName.toHapi():
    ...
    hapiValue.setType(org.hl7.fhir.r4.model.DeviceDefinition.DeviceNameType.valueOf(type.value.name.replace("_","")))
    return hapiValue
  }

  public fun DeviceDefinition.Specialization.toHapi():
  ...
  public fun DeviceDefinition.Capability.toHapi():
  ...
  public fun DeviceDefinition.Property.toHapi():
  ...
  public fun DeviceDefinition.Material.toHapi():
