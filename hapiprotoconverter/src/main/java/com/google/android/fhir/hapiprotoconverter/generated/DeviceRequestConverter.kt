...
public object DeviceRequestConverter {
  public fun DeviceRequest.CodeX.deviceRequestCodeToHapi(): Type {
  ...
  public fun DeviceRequest.Parameter.ValueX.deviceRequestParameterValueToHapi(): Type {
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
      return (this.getCodeableConcept()).toHapi()
    }
  ...
  public fun DeviceRequest.OccurrenceX.deviceRequestOccurrenceToHapi(): Type {
  ...
  public fun org.hl7.fhir.r4.model.DeviceRequest.DeviceRequestParameterComponent.toProto():
  ...
  public fun DeviceRequest.Parameter.toHapi():
