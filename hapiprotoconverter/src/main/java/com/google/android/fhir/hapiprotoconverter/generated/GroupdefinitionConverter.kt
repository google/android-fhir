...
import com.google.fhir.r4.core.Groupdefinition
...
public object GroupdefinitionConverter {
  ...
  public fun Groupdefinition.toHapi(): org.hl7.fhir.r4.model.Groupdefinition {
    val hapiValue = org.hl7.fhir.r4.model.Groupdefinition()
  ...
  public fun org.hl7.fhir.r4.model.Groupdefinition.toProto(): Groupdefinition {
    val protoValue = Groupdefinition.newBuilder()
    ...
    .setType(Groupdefinition.TypeCode.newBuilder().setValue(GroupTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
