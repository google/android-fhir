...
public object OperationDefinitionConverter {
  public fun OperationDefinition.toHapi(): org.hl7.fhir.r4.model.OperationDefinition {
    ...
    resourceList.map{hapiValue.addResource(Enumerations.ResourceType.valueOf(it.value.name.replace("_","")))}
  ...
  public fun org.hl7.fhir.r4.model.OperationDefinition.toProto(): OperationDefinition {
    ...
    .addAllResource(resource.map{OperationDefinition.ResourceCode.newBuilder().setValue(ResourceTypeCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
  ...
  public
    ...
    .addAllPart(part.map{it.toProto()})
    .build()
    return protoValue
  }
  ...
  public fun OperationDefinition.Parameter.toHapi():
    ...
    hapiValue.setPart(partList.map{it.toHapi()})
    return hapiValue
  }

  public fun OperationDefinition.Parameter.Binding.toHapi():
  ...
  public fun OperationDefinition.Parameter.ReferencedFrom.toHapi():
  ...
  public fun OperationDefinition.Overload.toHapi():
