...
public object AllergyIntoleranceConverter {
  public fun AllergyIntolerance.OnsetX.allergyIntoleranceOnsetToHapi(): Type {
  ...
  public fun AllergyIntolerance.toHapi(): org.hl7.fhir.r4.model.AllergyIntolerance {
    ...
    hapiValue.setType(org.hl7.fhir.r4.model.AllergyIntolerance.AllergyIntoleranceType.valueOf(type.value.name.replace("_","")))
    categoryList.map{hapiValue.addCategory(org.hl7.fhir.r4.model.AllergyIntolerance.AllergyIntoleranceCategory.valueOf(it.value.name.replace("_","")))}
    hapiValue.setCriticality(org.hl7.fhir.r4.model.AllergyIntolerance.AllergyIntoleranceCriticality.valueOf(criticality.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.AllergyIntolerance.toProto(): AllergyIntolerance {
    ...
    .setType(AllergyIntolerance.TypeCode.newBuilder().setValue(AllergyIntoleranceTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
    .addAllCategory(category.map{AllergyIntolerance.CategoryCode.newBuilder().setValue(AllergyIntoleranceCategoryCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
    .setCriticality(AllergyIntolerance.CriticalityCode.newBuilder().setValue(AllergyIntoleranceCriticalityCode.Value.valueOf(criticality.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.AllergyIntolerance.AllergyIntoleranceReactionComponent.toProto():
    ...
    .setSeverity(AllergyIntolerance.Reaction.SeverityCode.newBuilder().setValue(AllergyIntoleranceSeverityCode.Value.valueOf(severity.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun AllergyIntolerance.Reaction.toHapi():
    ...
    hapiValue.setSeverity(org.hl7.fhir.r4.model.AllergyIntolerance.AllergyIntoleranceSeverity.valueOf(severity.value.name.replace("_","")))
