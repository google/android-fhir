...
public object BiologicallyDerivedProductConverter {
  ...
  public fun BiologicallyDerivedProduct.toHapi(): org.hl7.fhir.r4.model.BiologicallyDerivedProduct {
    ...
    hapiValue.setProductCategory(org.hl7.fhir.r4.model.BiologicallyDerivedProduct.BiologicallyDerivedProductCategory.valueOf(productCategory.value.name.replace("_","")))
    hapiValue.setProductCode(productCode.toHapi())
    hapiValue.setStatus(org.hl7.fhir.r4.model.BiologicallyDerivedProduct.BiologicallyDerivedProductStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.BiologicallyDerivedProduct.toProto():
    ...
    .setProductCategory(BiologicallyDerivedProduct.ProductCategoryCode.newBuilder().setValue(BiologicallyDerivedProductCategoryCode.Value.valueOf(productCategory.toCode().replace("-",
        "_").toUpperCase())).build())
    .setProductCode(productCode.toProto())
    .setStatus(BiologicallyDerivedProduct.StatusCode.newBuilder().setValue(BiologicallyDerivedProductStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .setScale(BiologicallyDerivedProduct.Storage.ScaleCode.newBuilder().setValue(BiologicallyDerivedProductStorageScaleCode.Value.valueOf(scale.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun BiologicallyDerivedProduct.Collection.toHapi():
  ...
  public fun BiologicallyDerivedProduct.Processing.toHapi():
  ...
  public fun BiologicallyDerivedProduct.Manipulation.toHapi():
  ...
  public fun BiologicallyDerivedProduct.Storage.toHapi():
    ...
    hapiValue.setScale(org.hl7.fhir.r4.model.BiologicallyDerivedProduct.BiologicallyDerivedProductStorageScale.valueOf(scale.value.name.replace("_","")))
