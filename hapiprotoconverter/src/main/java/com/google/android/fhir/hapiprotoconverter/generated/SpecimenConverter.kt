...
public object SpecimenConverter {
  public fun Specimen.Collection.CollectedX.specimenCollectionCollectedToHapi(): Type {
  ...
  public fun Specimen.Collection.FastingStatusX.specimenCollectionFastingStatusToHapi(): Type {
  ...
  public fun Specimen.Processing.TimeX.specimenProcessingTimeToHapi(): Type {
    if (this.getDateTime() != DateTime.newBuilder().defaultInstanceForType ) {
      return (this.getDateTime()).toHapi()
    }
    if (this.getPeriod() != Period.newBuilder().defaultInstanceForType ) {
  ...
  public fun Specimen.Container.AdditiveX.specimenContainerAdditiveToHapi(): Type {
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
      return (this.getCodeableConcept()).toHapi()
    }
  ...
  public fun org.hl7.fhir.r4.model.Specimen.SpecimenCollectionComponent.toProto():
      Specimen.Collection {
  ...
  public fun org.hl7.fhir.r4.model.Specimen.SpecimenProcessingComponent.toProto():
      Specimen.Processing {
  ...
  public fun org.hl7.fhir.r4.model.Specimen.SpecimenContainerComponent.toProto():
      Specimen.Container {
  ...
  public fun Specimen.Collection.toHapi():
  ...
  public fun Specimen.Processing.toHapi():
  ...
  public fun Specimen.Container.toHapi():
