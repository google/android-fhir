...
public object ImagingStudyConverter {
  public fun ImagingStudy.toHapi(): org.hl7.fhir.r4.model.ImagingStudy {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.ImagingStudy.ImagingStudyStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.ImagingStudy.toProto(): ImagingStudy {
    ...
    .setStatus(ImagingStudy.StatusCode.newBuilder().setValue(ImagingStudyStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.ImagingStudy.ImagingStudySeriesComponent.toProto():
      ImagingStudy.Series {
  ...
  public fun org.hl7.fhir.r4.model.ImagingStudy.ImagingStudySeriesPerformerComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.ImagingStudy.ImagingStudySeriesInstanceComponent.toProto():
  ...
  public fun ImagingStudy.Series.toHapi():
  ...
  public fun ImagingStudy.Series.Performer.toHapi():
  ...
  public fun ImagingStudy.Series.Instance.toHapi():
