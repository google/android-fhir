...
public object TerminologyCapabilitiesConverter {
  public fun TerminologyCapabilities.toHapi(): org.hl7.fhir.r4.model.TerminologyCapabilities {
    ...
    hapiValue.setKind(org.hl7.fhir.r4.model.TerminologyCapabilities.CapabilityStatementKind.valueOf(kind.value.name.replace("_","")))
    ...
    hapiValue.setCodeSearch(org.hl7.fhir.r4.model.TerminologyCapabilities.CodeSearchSupport.valueOf(codeSearch.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.TerminologyCapabilities.toProto(): TerminologyCapabilities {
    ...
    .setStatus(TerminologyCapabilities.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setKind(TerminologyCapabilities.KindCode.newBuilder().setValue(CapabilityStatementKindCode.Value.valueOf(kind.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setCodeSearch(TerminologyCapabilities.CodeSearchCode.newBuilder().setValue(CodeSearchSupportCode.Value.valueOf(codeSearch.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun TerminologyCapabilities.Software.toHapi():
  ...
  public fun TerminologyCapabilities.Implementation.toHapi():
  ...
  public fun TerminologyCapabilities.CodeSystem.toHapi():
  ...
  public fun TerminologyCapabilities.CodeSystem.Version.toHapi():
  ...
  public fun TerminologyCapabilities.CodeSystem.Version.Filter.toHapi():
  ...
  public fun TerminologyCapabilities.Expansion.toHapi():
  ...
  public fun TerminologyCapabilities.Expansion.Parameter.toHapi():
  ...
  public fun TerminologyCapabilities.ValidateCode.toHapi():
  ...
  public fun TerminologyCapabilities.Translation.toHapi():
  ...
  public fun TerminologyCapabilities.Closure.toHapi():
