...
public object SupplyDeliveryConverter {
  public fun SupplyDelivery.SuppliedItem.ItemX.supplyDeliverySuppliedItemItemToHapi(): Type {
  ...
  public fun SupplyDelivery.OccurrenceX.supplyDeliveryOccurrenceToHapi(): Type {
  ...
  public fun SupplyDelivery.toHapi(): org.hl7.fhir.r4.model.SupplyDelivery {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.SupplyDelivery.SupplyDeliveryStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.SupplyDelivery.toProto(): SupplyDelivery {
    ...
    .setStatus(SupplyDelivery.StatusCode.newBuilder().setValue(SupplyDeliveryStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.SupplyDelivery.SupplyDeliverySuppliedItemComponent.toProto():
  ...
  public fun SupplyDelivery.SuppliedItem.toHapi():
