...
public object SearchParameterConverter {
  public fun SearchParameter.toHapi(): org.hl7.fhir.r4.model.SearchParameter {
    ...
    baseList.map{hapiValue.addBase(Enumerations.ResourceType.valueOf(it.value.name.replace("_","")))}
    ...
    targetList.map{hapiValue.addTarget(Enumerations.ResourceType.valueOf(it.value.name.replace("_","")))}
  ...
  public fun org.hl7.fhir.r4.model.SearchParameter.toProto(): SearchParameter {
    ...
    .addAllBase(base.map{SearchParameter.BaseCode.newBuilder().setValue(ResourceTypeCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
    ...
    .setXpathUsage(SearchParameter.XpathUsageCode.newBuilder().setValue(XPathUsageTypeCode.Value.valueOf(xpathUsage.toCode().replace("-",
        "_").toUpperCase())).build())
    .addAllTarget(target.map{SearchParameter.TargetCode.newBuilder().setValue(ResourceTypeCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
  ...
  public fun org.hl7.fhir.r4.model.SearchParameter.SearchParameterComponentComponent.toProto():
  ...
  public fun SearchParameter.Component.toHapi():
