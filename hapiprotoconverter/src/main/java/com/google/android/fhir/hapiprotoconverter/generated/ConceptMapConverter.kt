...
public object ConceptMapConverter {
  ...
  private fun org.hl7.fhir.r4.model.ConceptMap.TargetElementComponent.toProto():
    ...
    .setCode(codeElement.toProto())
    .setDisplay(displayElement.toProto())
    .setEquivalence(ConceptMap.Group.SourceElement.TargetElement.EquivalenceCode.newBuilder().setValue(ConceptMapEquivalenceCode.Value.valueOf(equivalence.toCode().replace("-",
        "_").toUpperCase())).build())
