...
public object PatientConverter {
  public fun Patient.DeceasedX.patientDeceasedToHapi(): Type {
  ...
  public fun Patient.MultipleBirthX.patientMultipleBirthToHapi(): Type {
    if (this.getBoolean() != Boolean.newBuilder().defaultInstanceForType ) {
      return (this.getBoolean()).toHapi()
    }
  ...
  public fun org.hl7.fhir.r4.model.Patient.ContactComponent.toProto(): Patient.Contact {
  ...
  public fun org.hl7.fhir.r4.model.Patient.PatientCommunicationComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.Patient.PatientLinkComponent.toProto(): Patient.Link {
  ...
  public fun Patient.Contact.toHapi(): org.hl7.fhir.r4.model.Patient.ContactComponent {
  ...
  public fun Patient.Communication.toHapi():
  ...
  public fun Patient.Link.toHapi(): org.hl7.fhir.r4.model.Patient.PatientLinkComponent {
