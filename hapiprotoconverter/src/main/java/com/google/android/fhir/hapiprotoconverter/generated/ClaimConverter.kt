...
public object ClaimConverter {
  public fun Claim.SupportingInfo.TimingX.claimSupportingInfoTimingToHapi(): Type {
  ...
  public fun Type.claimSupportingInfoTimingToProto(): Claim.SupportingInfo.TimingX {
    val protoValue = Claim.SupportingInfo.TimingX.newBuilder()
    if (this is DateType) {
  ...
  public fun Claim.SupportingInfo.ValueX.claimSupportingInfoValueToHapi(): Type {
  ...
  public fun Type.claimSupportingInfoValueToProto(): Claim.SupportingInfo.ValueX {
    val protoValue = Claim.SupportingInfo.ValueX.newBuilder()
  ...
  public fun Claim.Diagnosis.DiagnosisX.claimDiagnosisDiagnosisToHapi(): Type {
  ...
  public fun Claim.Procedure.ProcedureX.claimProcedureProcedureToHapi(): Type {
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
      return (this.getCodeableConcept()).toHapi()
    }
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
  ...
  public fun Claim.Accident.LocationX.claimAccidentLocationToHapi(): Type {
  ...
  public fun Claim.Item.ServicedX.claimItemServicedToHapi(): Type {
    if (this.getDate() != Date.newBuilder().defaultInstanceForType ) {
      return (this.getDate()).toHapi()
    }
    if (this.getPeriod() != Period.newBuilder().defaultInstanceForType ) {
  ...
  public fun Claim.Item.LocationX.claimItemLocationToHapi(): Type {
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
      return (this.getCodeableConcept()).toHapi()
    }
    if (this.getAddress() != Address.newBuilder().defaultInstanceForType ) {
  ...
  public fun org.hl7.fhir.r4.model.Claim.RelatedClaimComponent.toProto(): Claim.RelatedClaim {
  ...
  public fun org.hl7.fhir.r4.model.Claim.PayeeComponent.toProto(): Claim.Payee {
  ...
  public fun org.hl7.fhir.r4.model.Claim.CareTeamComponent.toProto(): Claim.CareTeam {
  ...
  public fun org.hl7.fhir.r4.model.Claim.SupportingInformationComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.Claim.DiagnosisComponent.toProto(): Claim.Diagnosis {
  ...
  public fun org.hl7.fhir.r4.model.Claim.ProcedureComponent.toProto(): Claim.Procedure {
  ...
  public fun org.hl7.fhir.r4.model.Claim.InsuranceComponent.toProto(): Claim.Insurance {
  ...
  public fun org.hl7.fhir.r4.model.Claim.AccidentComponent.toProto(): Claim.Accident {
  ...
  public fun org.hl7.fhir.r4.model.Claim.ItemComponent.toProto(): Claim.Item {
  ...
  public fun org.hl7.fhir.r4.model.Claim.DetailComponent.toProto(): Claim.Item.Detail {
  ...
  public fun org.hl7.fhir.r4.model.Claim.SubDetailComponent.toProto(): Claim.Item.Detail.SubDetail {
  ...
  public fun Claim.RelatedClaim.toHapi(): org.hl7.fhir.r4.model.Claim.RelatedClaimComponent {
  ...
  public fun Claim.Payee.toHapi(): org.hl7.fhir.r4.model.Claim.PayeeComponent {
  ...
  public fun Claim.CareTeam.toHapi(): org.hl7.fhir.r4.model.Claim.CareTeamComponent {
  ...
  public fun Claim.SupportingInformation.toHapi():
  ...
  public fun Claim.Diagnosis.toHapi(): org.hl7.fhir.r4.model.Claim.DiagnosisComponent {
  ...
  public fun Claim.Procedure.toHapi(): org.hl7.fhir.r4.model.Claim.ProcedureComponent {
  ...
  public fun Claim.Insurance.toHapi(): org.hl7.fhir.r4.model.Claim.InsuranceComponent {
  ...
  public fun Claim.Accident.toHapi(): org.hl7.fhir.r4.model.Claim.AccidentComponent {
  ...
  public fun Claim.Item.toHapi(): org.hl7.fhir.r4.model.Claim.ItemComponent {
  ...
  public fun Claim.Item.Detail.toHapi(): org.hl7.fhir.r4.model.Claim.DetailComponent {
  ...
  public fun Claim.Item.Detail.SubDetail.toHapi(): org.hl7.fhir.r4.model.Claim.SubDetailComponent {
