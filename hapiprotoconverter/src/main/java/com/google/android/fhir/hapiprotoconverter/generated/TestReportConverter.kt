...
public object TestReportConverter {
  ...
  private fun org.hl7.fhir.r4.model.TestReport.SetupActionOperationComponent.toProto():
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setResult(TestReport.Setup.SetupAction.Operation.ResultCode.newBuilder().setValue(TestReportActionResultCode.Value.valueOf(result.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  private fun org.hl7.fhir.r4.model.TestReport.SetupActionAssertComponent.toProto():
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setResult(TestReport.Setup.SetupAction.Assert.ResultCode.newBuilder().setValue(TestReportActionResultCode.Value.valueOf(result.toCode().replace("-",
        "_").toUpperCase())).build())
    .setMessage(messageElement.toProto())
    .setDetail(detailElement.toProto())
    .build()
