...
public object MedicationRequestConverter {
  public fun MedicationRequest.ReportedX.medicationRequestReportedToHapi(): Type {
  ...
  public fun MedicationRequest.MedicationX.medicationRequestMedicationToHapi(): Type {
  ...
  public fun MedicationRequest.Substitution.AllowedX.medicationRequestSubstitutionAllowedToHapi():
      Type {
    if (this.getBoolean() != Boolean.newBuilder().defaultInstanceForType ) {
      return (this.getBoolean()).toHapi()
    }
  ...
  public fun MedicationRequest.DispenseRequest.toHapi():
  ...
  public fun MedicationRequest.DispenseRequest.InitialFill.toHapi():
  ...
  public fun MedicationRequest.Substitution.toHapi():
