...
public object AccountConverter {
  public fun Account.toHapi(): org.hl7.fhir.r4.model.Account {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.Account.AccountStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.Account.toProto(): Account {
    ...
    .setStatus(Account.StatusCode.newBuilder().setValue(AccountStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.Account.CoverageComponent.toProto(): Account.Coverage {
  ...
  public fun org.hl7.fhir.r4.model.Account.GuarantorComponent.toProto(): Account.Guarantor {
  ...
  public fun Account.Coverage.toHapi(): org.hl7.fhir.r4.model.Account.CoverageComponent {
  ...
  public fun Account.Guarantor.toHapi(): org.hl7.fhir.r4.model.Account.GuarantorComponent {
