...
public object QuestionnaireConverter {
  public fun Questionnaire.Item.EnableWhen.AnswerX.questionnaireItemEnableWhenAnswerToHapi(): Type {
  ...
  public fun Questionnaire.Item.AnswerOption.ValueX.questionnaireItemAnswerOptionValueToHapi():
      Type {
    if (this.getInteger() != Integer.newBuilder().defaultInstanceForType ) {
      return (this.getInteger()).toHapi()
    }
  ...
  public fun Questionnaire.Item.Initial.ValueX.questionnaireItemInitialValueToHapi(): Type {
    if (this.getBoolean() != Boolean.newBuilder().defaultInstanceForType ) {
      return (this.getBoolean()).toHapi()
    }
    if (this.getDecimal() != Decimal.newBuilder().defaultInstanceForType ) {
  ...
  public fun Questionnaire.toHapi(): org.hl7.fhir.r4.model.Questionnaire {
    ...
    subjectTypeList.map{hapiValue.addSubjectType(Enumerations.ResourceType.valueOf(it.value.name.replace("_","")))}
  ...
  public fun org.hl7.fhir.r4.model.Questionnaire.toProto(): Questionnaire {
    ...
    .addAllSubjectType(subjectType.map{Questionnaire.SubjectTypeCode.newBuilder().setValue(ResourceTypeCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
  ...
  public fun org.hl7.fhir.r4.model.Questionnaire.QuestionnaireItemComponent.toProto():
      Questionnaire.Item {
  ...
  public fun org.hl7.fhir.r4.model.Questionnaire.QuestionnaireItemEnableWhenComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.Questionnaire.QuestionnaireItemAnswerOptionComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.Questionnaire.QuestionnaireItemInitialComponent.toProto():
  ...
  public fun Questionnaire.Item.toHapi():
  ...
  public fun Questionnaire.Item.EnableWhen.toHapi():
  ...
  public fun Questionnaire.Item.AnswerOption.toHapi():
  ...
  public fun Questionnaire.Item.Initial.toHapi():
