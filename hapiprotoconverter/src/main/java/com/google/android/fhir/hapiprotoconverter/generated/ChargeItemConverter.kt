...
public object ChargeItemConverter {
  public fun ChargeItem.OccurrenceX.chargeItemOccurrenceToHapi(): Type {
  ...
  public fun ChargeItem.ProductX.chargeItemProductToHapi(): Type {
  ...
  public fun org.hl7.fhir.r4.model.ChargeItem.ChargeItemPerformerComponent.toProto():
  ...
  public fun ChargeItem.Performer.toHapi():
