...
import com.google.fhir.r4.core.Shareablecodesystem
...
public object ShareablecodesystemConverter {
  public fun CodeSystem.Concept.Property.ValueX.codeSystemConceptPropertyValueToHapi(): Type {
  ...
  public fun Type.codeSystemConceptPropertyValueToProto(): CodeSystem.Concept.Property.ValueX {
    val protoValue = CodeSystem.Concept.Property.ValueX.newBuilder()
    if (this is CodeType) {
  ...
  public fun Shareablecodesystem.toHapi(): org.hl7.fhir.r4.model.Shareablecodesystem {
    val hapiValue = org.hl7.fhir.r4.model.Shareablecodesystem()
    ...
    hapiValue.setHierarchyMeaning(org.hl7.fhir.r4.model.CodeSystem.CodeSystemHierarchyMeaning.valueOf(hierarchyMeaning.value.name.replace("_","")))
    hapiValue.setCompositionalElement(compositional.toHapi())
    hapiValue.setVersionNeededElement(versionNeeded.toHapi())
    hapiValue.setContent(org.hl7.fhir.r4.model.CodeSystem.CodeSystemContentMode.valueOf(content.value.name.replace("_","")))
    ...
    hapiValue.setConceptDefinition(conceptDefinitionList.map{it.toHapi()})
    return hapiValue
  }

  public fun org.hl7.fhir.r4.model.Shareablecodesystem.toProto(): Shareablecodesystem {
    val protoValue = Shareablecodesystem.newBuilder()
    ...
    .setStatus(Shareablecodesystem.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setHierarchyMeaning(Shareablecodesystem.HierarchyMeaningCode.newBuilder().setValue(CodeSystemHierarchyMeaningCode.Value.valueOf(hierarchyMeaning.toCode().replace("-",
        "_").toUpperCase())).build())
    .setCompositional(compositionalElement.toProto())
    .setVersionNeeded(versionNeededElement.toProto())
    .setContent(Shareablecodesystem.ContentCode.newBuilder().setValue(CodeSystemContentModeCode.Value.valueOf(content.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .addAllConceptDefinition(conceptDefinition.map{it.toProto()})
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.CodeSystem.CodeSystemFilterComponent.toProto():
      CodeSystem.Filter {
    ...
    .setDescription(descriptionElement.toProto())
    .addAllOperator(operator.map{Shareablecodesystem.Filter.OperatorCode.newBuilder().setValue(FilterOperatorCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
  ...
  public fun org.hl7.fhir.r4.model.CodeSystem.PropertyComponent.toProto(): CodeSystem.Property {
    ...
    .setDescription(descriptionElement.toProto())
    .setType(Shareablecodesystem.Property.TypeCode.newBuilder().setValue(PropertyTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.CodeSystem.ConceptDefinitionComponent.toProto():
    ...
    .addAllConceptProperty(conceptProperty.map{it.toProto()})
    .addAllConcept(concept.map{it.toProto()})
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.CodeSystem.CodeSystemConceptDesignationComponent.toProto():
      CodeSystem.Concept.Designation {
    val protoValue = CodeSystem.Concept.Designation.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setLanguage(languageElement.toProto())
  ...
  public fun org.hl7.fhir.r4.model.CodeSystem.ConceptPropertyComponent.toProto():
      CodeSystem.Concept.ConceptProperty {
    val protoValue = CodeSystem.Concept.ConceptProperty.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setCode(codeElement.toProto())
  ...
  public fun CodeSystem.Filter.toHapi():
    ...
    hapiValue.setDescriptionElement(description.toHapi())
    operatorList.map{hapiValue.addOperator(org.hl7.fhir.r4.model.CodeSystem.FilterOperator.valueOf(it.value.name.replace("_","")))}
    hapiValue.setValueElement(value.toHapi())
    return hapiValue
  }

  public fun CodeSystem.Property.toHapi(): org.hl7.fhir.r4.model.CodeSystem.PropertyComponent {
    ...
    hapiValue.setDescriptionElement(description.toHapi())
    hapiValue.setType(org.hl7.fhir.r4.model.CodeSystem.PropertyType.valueOf(type.value.name.replace("_","")))
    return hapiValue
  }

  public fun CodeSystem.ConceptDefinition.toHapi():
    ...
    hapiValue.setConceptProperty(conceptPropertyList.map{it.toHapi()})
    hapiValue.setConcept(conceptList.map{it.toHapi()})
    return hapiValue
  }

  public fun CodeSystem.Concept.Designation.toHapi():
      org.hl7.fhir.r4.model.CodeSystem.CodeSystemConceptDesignationComponent {
    val hapiValue = org.hl7.fhir.r4.model.CodeSystem.CodeSystemConceptDesignationComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setLanguageElement(language.toHapi())
  ...
  public fun CodeSystem.Concept.ConceptProperty.toHapi():
