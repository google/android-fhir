...
import com.google.fhir.r4.core.Triglyceride
...
public object TriglycerideConverter {
  ...
  public fun Triglyceride.toHapi(): org.hl7.fhir.r4.model.Triglyceride {
    val hapiValue = org.hl7.fhir.r4.model.Triglyceride()
  ...
  public fun org.hl7.fhir.r4.model.Triglyceride.toProto(): Triglyceride {
    val protoValue = Triglyceride.newBuilder()
    ...
    .setStatus(Triglyceride.StatusCode.newBuilder().setValue(ObservationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
