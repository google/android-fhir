...
public object RiskEvidenceSynthesisConverter {
  ...
  public fun org.hl7.fhir.r4.model.RiskEvidenceSynthesis.toProto(): RiskEvidenceSynthesis {
    ...
    .setStatus(RiskEvidenceSynthesis.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun RiskEvidenceSynthesis.SampleSize.toHapi():
  ...
  public fun RiskEvidenceSynthesis.RiskEstimate.toHapi():
  ...
  public fun RiskEvidenceSynthesis.RiskEstimate.PrecisionEstimate.toHapi():
  ...
  public fun RiskEvidenceSynthesis.Certainty.toHapi():
  ...
  public fun RiskEvidenceSynthesis.Certainty.CertaintySubcomponent.toHapi():
