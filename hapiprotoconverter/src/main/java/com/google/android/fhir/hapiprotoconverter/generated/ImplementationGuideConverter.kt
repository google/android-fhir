...
public object ImplementationGuideConverter {
  ...
  public
      fun ImplementationGuide.Manifest.Resource.ExampleX.implementationGuideManifestResourceExampleToHapi():
      Type {
    if (this.getBoolean() != Boolean.newBuilder().defaultInstanceForType ) {
      return (this.getBoolean()).toHapi()
    }
  ...
  public fun Type.implementationGuideManifestResourceExampleToProto():
      ImplementationGuide.Manifest.Resource.ExampleX {
    val protoValue = ImplementationGuide.Manifest.Resource.ExampleX.newBuilder()
    if (this is BooleanType) {
      protoValue.setBoolean(this.toProto())
    }
    if (this is CanonicalType) {
  ...
  public fun org.hl7.fhir.r4.model.ImplementationGuide.ImplementationGuideGlobalComponent.toProto():
      ImplementationGuide.Global {
    val protoValue = ImplementationGuide.Global.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setType(ImplementationGuide.Global.TypeCode.newBuilder().setValue(ResourceTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setCode(ImplementationGuide.Definition.Parameter.CodeCode.newBuilder().setValue(GuideParameterCode.Value.valueOf(code.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .addAllManifestResource(manifestResource.map{it.toProto()})
    .addAllManifestPage(manifestPage.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.ImplementationGuide.ManifestResourceComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.ImplementationGuide.ManifestPageComponent.toProto():
  ...
  public fun ImplementationGuide.DependsOn.toHapi():
  ...
  public fun ImplementationGuide.Global.toHapi():
  ...
  public fun ImplementationGuide.Definition.toHapi():
  ...
  public fun ImplementationGuide.Definition.Grouping.toHapi():
  ...
  public fun ImplementationGuide.Definition.Resource.toHapi():
  ...
  public fun ImplementationGuide.Definition.Page.toHapi():
  ...
  public fun ImplementationGuide.Definition.Parameter.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setCode(org.hl7.fhir.r4.model.ImplementationGuide.GuideParameterCode.valueOf(code.value.name.replace("_","")))
    hapiValue.setValueElement(value.toHapi())
    return hapiValue
  }

  public fun ImplementationGuide.Definition.Template.toHapi():
  ...
  public fun ImplementationGuide.Manifest.toHapi():
    ...
    hapiValue.setManifestResource(manifestResourceList.map{it.toHapi()})
    hapiValue.setManifestPage(manifestPageList.map{it.toHapi()})
    hapiValue.setImage(imageList.map{it.toHapi()})
    hapiValue.setOther(otherList.map{it.toHapi()})
    return hapiValue
  }

  public fun ImplementationGuide.Manifest.ManifestResource.toHapi():
  ...
  public fun ImplementationGuide.Manifest.ManifestPage.toHapi():
