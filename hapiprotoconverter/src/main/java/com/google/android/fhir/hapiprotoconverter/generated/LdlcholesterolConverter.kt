...
import com.google.fhir.r4.core.Ldlcholesterol
...
public object LdlcholesterolConverter {
  ...
  public fun Ldlcholesterol.toHapi(): org.hl7.fhir.r4.model.Ldlcholesterol {
    val hapiValue = org.hl7.fhir.r4.model.Ldlcholesterol()
  ...
  public fun org.hl7.fhir.r4.model.Ldlcholesterol.toProto(): Ldlcholesterol {
    val protoValue = Ldlcholesterol.newBuilder()
    ...
    .setStatus(Ldlcholesterol.StatusCode.newBuilder().setValue(ObservationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
