...
import com.google.fhir.r4.core.Shareableactivitydefinition
...
public object ShareableactivitydefinitionConverter {
  public fun ActivityDefinition.SubjectX.activityDefinitionSubjectToHapi(): Type {
  ...
  public fun ActivityDefinition.TimingX.activityDefinitionTimingToHapi(): Type {
  ...
  public fun ActivityDefinition.ProductX.activityDefinitionProductToHapi(): Type {
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
      return (this.getReference()).toHapi()
    }
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
  ...
  public fun Shareableactivitydefinition.toHapi():
      org.hl7.fhir.r4.model.Shareableactivitydefinition {
    val hapiValue = org.hl7.fhir.r4.model.Shareableactivitydefinition()
    ...
    hapiValue.setKind(org.hl7.fhir.r4.model.ActivityDefinition.ActivityDefinitionKind.valueOf(kind.value.name.replace("_","")))
    hapiValue.setProfileElement(profile.toHapi())
    hapiValue.setCode(code.toHapi())
    hapiValue.setIntent(org.hl7.fhir.r4.model.ActivityDefinition.RequestIntent.valueOf(intent.value.name.replace("_","")))
    hapiValue.setPriority(org.hl7.fhir.r4.model.ActivityDefinition.RequestPriority.valueOf(priority.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.Shareableactivitydefinition.toProto():
      Shareableactivitydefinition {
    val protoValue = Shareableactivitydefinition.newBuilder()
    ...
    .setStatus(Shareableactivitydefinition.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setKind(Shareableactivitydefinition.KindCode.newBuilder().setValue(RequestResourceTypeCode.Value.valueOf(kind.toCode().replace("-",
        "_").toUpperCase())).build())
    .setProfile(profileElement.toProto())
    .setCode(code.toProto())
    .setIntent(Shareableactivitydefinition.IntentCode.newBuilder().setValue(RequestIntentCode.Value.valueOf(intent.toCode().replace("-",
        "_").toUpperCase())).build())
    .setPriority(Shareableactivitydefinition.PriorityCode.newBuilder().setValue(RequestPriorityCode.Value.valueOf(priority.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setType(Shareableactivitydefinition.Participant.TypeCode.newBuilder().setValue(ActionParticipantTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun ActivityDefinition.Participant.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setType(org.hl7.fhir.r4.model.ActivityDefinition.ActivityParticipantType.valueOf(type.value.name.replace("_","")))
    hapiValue.setRole(role.toHapi())
    return hapiValue
  }

  public fun ActivityDefinition.DynamicValue.toHapi():
