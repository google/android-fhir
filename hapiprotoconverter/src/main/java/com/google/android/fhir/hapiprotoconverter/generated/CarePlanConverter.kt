...
public object CarePlanConverter {
  public fun CarePlan.Activity.Detail.ScheduledX.carePlanActivityDetailScheduledToHapi(): Type {
  ...
  public fun CarePlan.Activity.Detail.ProductX.carePlanActivityDetailProductToHapi(): Type {
  ...
  public fun CarePlan.toHapi(): org.hl7.fhir.r4.model.CarePlan {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.CarePlan.CarePlanStatus.valueOf(status.value.name.replace("_","")))
    hapiValue.setIntent(org.hl7.fhir.r4.model.CarePlan.CarePlanIntent.valueOf(intent.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.CarePlan.toProto(): CarePlan {
    ...
    .setStatus(CarePlan.StatusCode.newBuilder().setValue(RequestStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    .setIntent(CarePlan.IntentCode.newBuilder().setValue(CarePlanIntentValueSet.Value.valueOf(intent.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.CarePlan.CarePlanActivityComponent.toProto(): CarePlan.Activity {
  ...
  public fun org.hl7.fhir.r4.model.CarePlan.CarePlanActivityDetailComponent.toProto():
      CarePlan.Activity.Detail {
    val protoValue = CarePlan.Activity.Detail.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setKind(CarePlan.Activity.Detail.KindCode.newBuilder().setValue(CarePlanActivityKindValueSet.Value.valueOf(kind.toCode().replace("-",
        "_").toUpperCase())).build())
    .addAllInstantiatesCanonical(instantiatesCanonical.map{it.toProto()})
    .addAllInstantiatesUri(instantiatesUri.map{it.toProto()})
    ...
    .addAllGoal(goal.map{it.toProto()})
    .setStatus(CarePlan.Activity.Detail.StatusCode.newBuilder().setValue(CarePlanActivityStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun CarePlan.Activity.toHapi(): org.hl7.fhir.r4.model.CarePlan.CarePlanActivityComponent {
  ...
  public fun CarePlan.Activity.Detail.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setKind(org.hl7.fhir.r4.model.CarePlan.CarePlanActivityKind.valueOf(kind.value.name.replace("_","")))
    hapiValue.setInstantiatesCanonical(instantiatesCanonicalList.map{it.toHapi()})
    hapiValue.setInstantiatesUri(instantiatesUriList.map{it.toHapi()})
    ...
    hapiValue.setGoal(goalList.map{it.toHapi()})
    hapiValue.setStatus(org.hl7.fhir.r4.model.CarePlan.CarePlanActivityStatus.valueOf(status.value.name.replace("_","")))
