...
public object CodeSystemConverter {
  ...
  public fun org.hl7.fhir.r4.model.CodeSystem.toProto(): CodeSystem {
    ...
    .setStatus(CodeSystem.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setHierarchyMeaning(CodeSystem.HierarchyMeaningCode.newBuilder().setValue(CodeSystemHierarchyMeaningCode.Value.valueOf(hierarchyMeaning.toCode().replace("-",
        "_").toUpperCase())).build())
    .setCompositional(compositionalElement.toProto())
    .setVersionNeeded(versionNeededElement.toProto())
    .setContent(CodeSystem.ContentCode.newBuilder().setValue(CodeSystemContentModeCode.Value.valueOf(content.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.CodeSystem.CodeSystemFilterComponent.toProto():
    ...
    .setDescription(descriptionElement.toProto())
    .addAllOperator(operator.map{CodeSystem.Filter.OperatorCode.newBuilder().setValue(FilterOperatorCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
  ...
  public fun org.hl7.fhir.r4.model.CodeSystem.PropertyComponent.toProto(): CodeSystem.Property {
    ...
    .setDescription(descriptionElement.toProto())
    .setType(CodeSystem.Property.TypeCode.newBuilder().setValue(PropertyTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
    .build()
    return protoValue
  }
