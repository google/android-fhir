...
public object VisionPrescriptionConverter {
  public fun VisionPrescription.toHapi(): org.hl7.fhir.r4.model.VisionPrescription {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.VisionPrescription.VisionStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.VisionPrescription.toProto(): VisionPrescription {
    ...
    .setStatus(VisionPrescription.StatusCode.newBuilder().setValue(FinancialResourceStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .setEye(VisionPrescription.LensSpecification.EyeCode.newBuilder().setValue(VisionEyesCode.Value.valueOf(eye.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.VisionPrescription.PrismComponent.toProto():
    ...
    .setBase(VisionPrescription.LensSpecification.Prism.BaseCode.newBuilder().setValue(VisionBaseCode.Value.valueOf(base.toCode().replace("-",
        "_").toUpperCase())).build())
    .build()
    return protoValue
  }

  public fun VisionPrescription.LensSpecification.toHapi():
    ...
    hapiValue.setEye(org.hl7.fhir.r4.model.VisionPrescription.VisionEyes.valueOf(eye.value.name.replace("_","")))
  ...
  public fun VisionPrescription.LensSpecification.Prism.toHapi():
    ...
    hapiValue.setBase(org.hl7.fhir.r4.model.VisionPrescription.VisionBase.valueOf(base.value.name.replace("_","")))
    return hapiValue
  }
}
