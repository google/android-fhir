...
public object MoneyQuantityConverter {
  public fun MoneyQuantity.toHapi(): org.hl7.fhir.r4.model.MoneyQuantity {
  ...
  public fun org.hl7.fhir.r4.model.MoneyQuantity.toProto(): MoneyQuantity {
    val protoValue = MoneyQuantity.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .setValue(valueElement.toProto())
    .setComparator(MoneyQuantity.ComparatorCode.newBuilder().setValue(QuantityComparatorCode.Value.valueOf(comparator.toCode().replace("-",
        "_").toUpperCase())).build())
