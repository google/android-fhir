...
public object OperationOutcomeConverter {
  ...
  public fun org.hl7.fhir.r4.model.OperationOutcome.OperationOutcomeIssueComponent.toProto():
    ...
    .setSeverity(OperationOutcome.Issue.SeverityCode.newBuilder().setValue(IssueSeverityCode.Value.valueOf(severity.toCode().replace("-",
        "_").toUpperCase())).build())
    .setCode(OperationOutcome.Issue.CodeCode.newBuilder().setValue(IssueTypeCode.Value.valueOf(code.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun OperationOutcome.Issue.toHapi():
