...
public object EventDefinitionConverter {
  public fun EventDefinition.SubjectX.eventDefinitionSubjectToHapi(): Type {
  ...
  public fun org.hl7.fhir.r4.model.EventDefinition.toProto(): EventDefinition {
    val protoValue = EventDefinition.newBuilder()
    ...
    .setStatus(EventDefinition.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
