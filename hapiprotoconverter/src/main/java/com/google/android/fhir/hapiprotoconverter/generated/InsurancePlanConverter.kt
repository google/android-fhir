...
public object InsurancePlanConverter {
  ...
  public fun org.hl7.fhir.r4.model.InsurancePlan.toProto(): InsurancePlan {
    ...
    .setStatus(InsurancePlan.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanContactComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanCoverageComponent.toProto():
    ...
    .addAllNetwork(network.map{it.toProto()})
    .addAllCoverageBenefit(coverageBenefit.map{it.toProto()})
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.InsurancePlan.CoverageBenefitComponent.toProto():
  ...
  public
      fun org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanCoverageBenefitLimitComponent.toProto():
      InsurancePlan.Coverage.Benefit.Limit {
    val protoValue = InsurancePlan.Coverage.Benefit.Limit.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanPlanComponent.toProto():
      InsurancePlan.Plan {
  ...
  public fun org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanPlanGeneralCostComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanPlanSpecificCostComponent.toProto():
    ...
    .addAllPlanBenefit(planBenefit.map{it.toProto()})
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.InsurancePlan.PlanBenefitComponent.toProto():
  ...
  public
      fun org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanPlanSpecificCostBenefitCostComponent.toProto():
      InsurancePlan.Plan.SpecificCost.Benefit.Cost {
    val protoValue = InsurancePlan.Plan.SpecificCost.Benefit.Cost.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setType(type.toProto())
  ...
  public fun InsurancePlan.Contact.toHapi():
  ...
  public fun InsurancePlan.Coverage.toHapi():
    ...
    hapiValue.setNetwork(networkList.map{it.toHapi()})
    hapiValue.setCoverageBenefit(coverageBenefitList.map{it.toHapi()})
    return hapiValue
  }

  public fun InsurancePlan.Coverage.CoverageBenefit.toHapi():
  ...
  public fun InsurancePlan.Coverage.Benefit.Limit.toHapi():
      org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanCoverageBenefitLimitComponent {
    val hapiValue = org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanCoverageBenefitLimitComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
  ...
  public fun InsurancePlan.Plan.toHapi():
  ...
  public fun InsurancePlan.Plan.GeneralCost.toHapi():
  ...
  public fun InsurancePlan.Plan.SpecificCost.toHapi():
    ...
    hapiValue.setPlanBenefit(planBenefitList.map{it.toHapi()})
    return hapiValue
  }

  public fun InsurancePlan.Plan.SpecificCost.PlanBenefit.toHapi():
  ...
  public fun InsurancePlan.Plan.SpecificCost.Benefit.Cost.toHapi():
      org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanPlanSpecificCostBenefitCostComponent {
    val hapiValue =
        org.hl7.fhir.r4.model.InsurancePlan.InsurancePlanPlanSpecificCostBenefitCostComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
