...
public object FamilyMemberHistoryConverter {
  public fun FamilyMemberHistory.BornX.familyMemberHistoryBornToHapi(): Type {
  ...
  public fun FamilyMemberHistory.AgeX.familyMemberHistoryAgeToHapi(): Type {
  ...
  public fun FamilyMemberHistory.DeceasedX.familyMemberHistoryDeceasedToHapi(): Type {
  ...
  public fun FamilyMemberHistory.Condition.OnsetX.familyMemberHistoryConditionOnsetToHapi(): Type {
    if (this.getAge() != Age.newBuilder().defaultInstanceForType ) {
      return (this.getAge()).toHapi()
    }
    if (this.getRange() != Range.newBuilder().defaultInstanceForType ) {
  ...
  public fun FamilyMemberHistory.toHapi(): org.hl7.fhir.r4.model.FamilyMemberHistory {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.FamilyMemberHistory.FamilyHistoryStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.FamilyMemberHistory.toProto(): FamilyMemberHistory {
    ...
    .setStatus(FamilyMemberHistory.StatusCode.newBuilder().setValue(FamilyHistoryStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun FamilyMemberHistory.Condition.toHapi():
