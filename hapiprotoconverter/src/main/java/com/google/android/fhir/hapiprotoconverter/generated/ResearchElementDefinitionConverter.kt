...
public object ResearchElementDefinitionConverter {
  public fun ResearchElementDefinition.SubjectX.researchElementDefinitionSubjectToHapi(): Type {
  ...
  public fun ResearchElementDefinition.toHapi(): org.hl7.fhir.r4.model.ResearchElementDefinition {
    ...
    hapiValue.setType(org.hl7.fhir.r4.model.ResearchElementDefinition.ResearchElementType.valueOf(type.value.name.replace("_","")))
    hapiValue.setVariableType(org.hl7.fhir.r4.model.ResearchElementDefinition.VariableType.valueOf(variableType.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.ResearchElementDefinition.toProto(): ResearchElementDefinition {
    ...
    .setStatus(ResearchElementDefinition.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setType(ResearchElementDefinition.TypeCode.newBuilder().setValue(ResearchElementTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
    .setVariableType(ResearchElementDefinition.VariableTypeCode.newBuilder().setValue(EvidenceVariableTypeCode.Value.valueOf(variableType.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .setStudyEffective(studyEffective.researchElementDefinitionCharacteristicStudyEffectiveToProto())
    .setStudyEffectiveTimeFromStart(studyEffectiveTimeFromStart.toProto())
    .setStudyEffectiveGroupMeasure(ResearchElementDefinition.Characteristic.StudyEffectiveGroupMeasureCode.newBuilder().setValue(GroupMeasureCode.Value.valueOf(studyEffectiveGroupMeasure.toCode().replace("-",
        "_").toUpperCase())).build())
    .setParticipantEffectiveDescription(participantEffectiveDescriptionElement.toProto())
    .setParticipantEffective(participantEffective.researchElementDefinitionCharacteristicParticipantEffectiveToProto())
    .setParticipantEffectiveTimeFromStart(participantEffectiveTimeFromStart.toProto())
    .setParticipantEffectiveGroupMeasure(ResearchElementDefinition.Characteristic.ParticipantEffectiveGroupMeasureCode.newBuilder().setValue(GroupMeasureCode.Value.valueOf(participantEffectiveGroupMeasure.toCode().replace("-",
        "_").toUpperCase())).build())
    .build()
    return protoValue
  }

  public fun ResearchElementDefinition.Characteristic.toHapi():
    ...
    hapiValue.setStudyEffectiveGroupMeasure(org.hl7.fhir.r4.model.ResearchElementDefinition.GroupMeasure.valueOf(studyEffectiveGroupMeasure.value.name.replace("_","")))
    ...
    hapiValue.setParticipantEffectiveGroupMeasure(org.hl7.fhir.r4.model.ResearchElementDefinition.GroupMeasure.valueOf(participantEffectiveGroupMeasure.value.name.replace("_","")))
    return hapiValue
  }
}
