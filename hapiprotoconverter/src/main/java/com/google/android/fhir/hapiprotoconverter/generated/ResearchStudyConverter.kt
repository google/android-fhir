...
public object ResearchStudyConverter {
  public fun ResearchStudy.toHapi(): org.hl7.fhir.r4.model.ResearchStudy {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.ResearchStudy.ResearchStudyStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.ResearchStudy.toProto(): ResearchStudy {
    ...
    .setStatus(ResearchStudy.StatusCode.newBuilder().setValue(ResearchStudyStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.ResearchStudy.ResearchStudyArmComponent.toProto():
      ResearchStudy.Arm {
  ...
  public fun org.hl7.fhir.r4.model.ResearchStudy.ResearchStudyObjectiveComponent.toProto():
  ...
  public fun ResearchStudy.Arm.toHapi():
  ...
  public fun ResearchStudy.Objective.toHapi():
