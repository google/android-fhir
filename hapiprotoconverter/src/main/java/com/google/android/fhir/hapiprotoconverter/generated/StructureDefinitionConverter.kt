...
public object StructureDefinitionConverter {
  public fun StructureDefinition.toHapi(): org.hl7.fhir.r4.model.StructureDefinition {
    ...
    hapiValue.setKind(org.hl7.fhir.r4.model.StructureDefinition.StructureDefinitionKind.valueOf(kind.value.name.replace("_","")))
    ...
    hapiValue.setDerivation(org.hl7.fhir.r4.model.StructureDefinition.TypeDerivationRule.valueOf(derivation.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.StructureDefinition.toProto(): StructureDefinition {
    ...
    .setStatus(StructureDefinition.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setFhirVersion(StructureDefinition.FhirVersionCode.newBuilder().setValue(FHIRVersionCode.Value.valueOf(fhirVersion.toCode().replace("-",
        "_").toUpperCase())).build())
    .addAllMapping(mapping.map{it.toProto()})
    .setKind(StructureDefinition.KindCode.newBuilder().setValue(StructureDefinitionKindCode.Value.valueOf(kind.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setDerivation(StructureDefinition.DerivationCode.newBuilder().setValue(TypeDerivationRuleCode.Value.valueOf(derivation.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setType(StructureDefinition.Context.TypeCode.newBuilder().setValue(ExtensionContextTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun StructureDefinition.Mapping.toHapi():
  ...
  public fun StructureDefinition.Context.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setType(org.hl7.fhir.r4.model.StructureDefinition.ExtensionContextType.valueOf(type.value.name.replace("_","")))
    hapiValue.setExpressionElement(expression.toHapi())
    return hapiValue
  }

  public fun StructureDefinition.Snapshot.toHapi():
  ...
  public fun StructureDefinition.Differential.toHapi():
