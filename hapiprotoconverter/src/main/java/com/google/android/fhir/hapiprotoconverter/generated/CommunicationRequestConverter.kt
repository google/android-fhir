...
public object CommunicationRequestConverter {
  public fun CommunicationRequest.Payload.ContentX.communicationRequestPayloadContentToHapi():
      Type {
  ...
  public fun CommunicationRequest.OccurrenceX.communicationRequestOccurrenceToHapi(): Type {
  ...
  public fun CommunicationRequest.Payload.toHapi():
