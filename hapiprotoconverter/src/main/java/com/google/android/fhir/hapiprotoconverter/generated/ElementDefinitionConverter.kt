...
public object ElementDefinitionConverter {
  public fun ElementDefinition.DefaultValueX.defaultValueToHapi(): Type {
    ...
    throw IllegalArgumentException("ElementDefinition.defaultValue[x]")
  }

  public fun Type.defaultValueToProto(): ElementDefinition.DefaultValueX {
  ...
  public fun ElementDefinition.FixedX.fixedToHapi(): Type {
    if (this.getBase64Binary() != Base64Binary.newBuilder().defaultInstanceForType ) {
      return (this.getBase64Binary()).toHapi()
    }
    if (this.getBoolean() != Boolean.newBuilder().defaultInstanceForType ) {
    ...
    throw IllegalArgumentException("ElementDefinition.fixed[x]")
  }

  public fun Type.fixedToProto(): ElementDefinition.FixedX {
  ...
  public fun ElementDefinition.PatternX.patternToHapi(): Type {
    if (this.getBase64Binary() != Base64Binary.newBuilder().defaultInstanceForType ) {
      return (this.getBase64Binary()).toHapi()
    }
    if (this.getBoolean() != Boolean.newBuilder().defaultInstanceForType ) {
    ...
    throw IllegalArgumentException("ElementDefinition.pattern[x]")
  }

  public fun Type.patternToProto(): ElementDefinition.PatternX {
  ...
  public fun ElementDefinition.Example.ValueX.valueToHapi(): Type {
    if (this.getBase64Binary() != Base64Binary.newBuilder().defaultInstanceForType ) {
      return (this.getBase64Binary()).toHapi()
    }
    if (this.getBoolean() != Boolean.newBuilder().defaultInstanceForType ) {
    ...
    throw IllegalArgumentException("ElementDefinition.example.value[x]")
  }

  public fun Type.valueToProto(): ElementDefinition.Example.ValueX {
  ...
  public fun ElementDefinition.MinValueX.minValueToHapi(): Type {
    if (this.getDate() != Date.newBuilder().defaultInstanceForType ) {
      return (this.getDate()).toHapi()
    }
    if (this.getDateTime() != DateTime.newBuilder().defaultInstanceForType ) {
    ...
    throw IllegalArgumentException("ElementDefinition.minValue[x]")
  }

  public fun Type.minValueToProto(): ElementDefinition.MinValueX {
  ...
  public fun ElementDefinition.MaxValueX.maxValueToHapi(): Type {
    if (this.getDate() != Date.newBuilder().defaultInstanceForType ) {
      return (this.getDate()).toHapi()
    }
    if (this.getDateTime() != DateTime.newBuilder().defaultInstanceForType ) {
    ...
    throw IllegalArgumentException("ElementDefinition.maxValue[x]")
  }

  public fun Type.maxValueToProto(): ElementDefinition.MaxValueX {
  ...
  public fun ElementDefinition.toHapi(): org.hl7.fhir.r4.model.ElementDefinition {
    ...
    representationList.map{hapiValue.addRepresentation(org.hl7.fhir.r4.model.ElementDefinition.PropertyRepresentation.valueOf(it.value.name.replace("_","")))}
    ...
    hapiValue.setTypeRef(TypeRefList.map{it.toHapi()})
    hapiValue.setDefaultValue(defaultValue.defaultValueToHapi())
    hapiValue.setMeaningWhenMissingElement(meaningWhenMissing.toHapi())
    hapiValue.setOrderMeaningElement(orderMeaning.toHapi())
    hapiValue.setFixed(fixed.fixedToHapi())
    hapiValue.setPattern(pattern.patternToHapi())
    hapiValue.setExample(exampleList.map{it.toHapi()})
    hapiValue.setMinValue(minValue.minValueToHapi())
    hapiValue.setMaxValue(maxValue.maxValueToHapi())
    ...
    hapiValue.setElementDefinitionBinding(ElementDefinitionBinding.toHapi())
  ...
  public fun org.hl7.fhir.r4.model.ElementDefinition.toProto(): ElementDefinition {
    ...
    .addAllRepresentation(representation.map{ElementDefinition.RepresentationCode.newBuilder().setValue(PropertyRepresentationCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
    ...
    .addAllTypeRef(TypeRef.map{it.toProto()})
    .setDefaultValue(defaultValue.defaultValueToProto())
    .setMeaningWhenMissing(meaningWhenMissingElement.toProto())
    .setOrderMeaning(orderMeaningElement.toProto())
    .setFixed(fixed.fixedToProto())
    .setPattern(pattern.patternToProto())
    .addAllExample(example.map{it.toProto()})
    .setMinValue(minValue.minValueToProto())
    .setMaxValue(maxValue.maxValueToProto())
    ...
    .setElementDefinitionBinding(ElementDefinitionBinding.toProto())
    .addAllMapping(mapping.map{it.toProto()})
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionSlicingComponent.toProto():
    ...
    .setRules(ElementDefinition.Slicing.RulesCode.newBuilder().setValue(SlicingRulesCode.Value.valueOf(rules.toCode().replace("-",
        "_").toUpperCase())).build())
    .build()
    return protoValue
  }
  ...
  public
      fun org.hl7.fhir.r4.model.ElementDefinition.slicing.ElementDefinitionDiscriminatorComponent.toProto():
      ElementDefinition.slicing.Discriminator {
    val protoValue = ElementDefinition.slicing.Discriminator.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .setType(ElementDefinition.Slicing.Discriminator.TypeCode.newBuilder().setValue(DiscriminatorTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
    .setPath(pathElement.toProto())
    .build()
    return protoValue
  ...
  public fun org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionBaseComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionTypeRefComponent.toProto():
    ...
    .addAllAggregation(aggregation.map{ElementDefinition.Type.AggregationCode.newBuilder().setValue(AggregationModeCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
    .setVersioning(ElementDefinition.Type.VersioningCode.newBuilder().setValue(ReferenceVersionRulesCode.Value.valueOf(versioning.toCode().replace("-",
        "_").toUpperCase())).build())
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionExampleComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionConstraintComponent.toProto():
    ...
    .setRequirements(requirementsElement.toProto())
    .setSeverity(ElementDefinition.Constraint.SeverityCode.newBuilder().setValue(ConstraintSeverityCode.Value.valueOf(severity.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
      fun org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionElementDefinitionBindingComponent.toProto():
      ElementDefinition.ElementDefinitionBinding {
    val protoValue = ElementDefinition.ElementDefinitionBinding.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .setStrength(ElementDefinition.Binding.StrengthCode.newBuilder().setValue(BindingStrengthCode.Value.valueOf(strength.toCode().replace("-",
        "_").toUpperCase())).build())
    .setDescription(descriptionElement.toProto())
  ...
  public fun org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionMappingComponent.toProto():
      ElementDefinition.Mapping {
    val protoValue = ElementDefinition.Mapping.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .setIdentity(identityElement.toProto())
    .setLanguage(ElementDefinition.Mapping.LanguageCode.newBuilder().setValue(language).build())
  ...
  public fun ElementDefinition.Slicing.toHapi():
    ...
    hapiValue.setRules(org.hl7.fhir.r4.model.ElementDefinition.SlicingRules.valueOf(rules.value.name.replace("_","")))
    return hapiValue
  }

  public fun ElementDefinition.slicing.Discriminator.toHapi():
      org.hl7.fhir.r4.model.ElementDefinition.slicing.ElementDefinitionDiscriminatorComponent {
    val hapiValue =
        org.hl7.fhir.r4.model.ElementDefinition.slicing.ElementDefinitionDiscriminatorComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setType(org.hl7.fhir.r4.model.ElementDefinition.DiscriminatorType.valueOf(type.value.name.replace("_","")))
    hapiValue.setPathElement(path.toHapi())
    return hapiValue
  }

  public fun ElementDefinition.Base.toHapi():
  ...
  public fun ElementDefinition.TypeRef.toHapi():
      org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionTypeRefComponent {
    val hapiValue = org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionTypeRefComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setCodeElement(code.toHapi())
    hapiValue.setProfile(profileList.map{it.toHapi()})
    hapiValue.setTargetProfile(targetProfileList.map{it.toHapi()})
    aggregationList.map{hapiValue.addAggregation(org.hl7.fhir.r4.model.ElementDefinition.AggregationMode.valueOf(it.value.name.replace("_","")))}
    hapiValue.setVersioning(org.hl7.fhir.r4.model.ElementDefinition.ReferenceVersionRules.valueOf(versioning.value.name.replace("_","")))
    return hapiValue
  }

  public fun ElementDefinition.Example.toHapi():
  ...
  public fun ElementDefinition.Constraint.toHapi():
    ...
    hapiValue.setRequirementsElement(requirements.toHapi())
    hapiValue.setSeverity(org.hl7.fhir.r4.model.ElementDefinition.ConstraintSeverity.valueOf(severity.value.name.replace("_","")))
  ...
  public fun ElementDefinition.ElementDefinitionBinding.toHapi():
      org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionElementDefinitionBindingComponent {
    val hapiValue =
        org.hl7.fhir.r4.model.ElementDefinition.ElementDefinitionElementDefinitionBindingComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setStrength(org.hl7.fhir.r4.model.ElementDefinition.BindingStrength.valueOf(strength.value.name.replace("_","")))
    hapiValue.setDescriptionElement(description.toHapi())
    hapiValue.setValueSetElement(valueSet.toHapi())
    return hapiValue
  }

  public fun ElementDefinition.Mapping.toHapi():
    ...
    hapiValue.setLanguage(language.value)
