...
import com.google.fhir.r4.core.Lipidprofile
...
public object LipidprofileConverter {
  ...
  public fun Lipidprofile.toHapi(): org.hl7.fhir.r4.model.Lipidprofile {
    val hapiValue = org.hl7.fhir.r4.model.Lipidprofile()
    ...
    hapiValue.setResult:Cholesterol(result:Cholesterol.toHapi())
    hapiValue.setResult:Triglyceride(result:Triglyceride.toHapi())
    hapiValue.setResult:HDLCholesterol(result:HDLCholesterol.toHapi())
    hapiValue.setResult:LDLCholesterol(result:LDLCholesterol.toHapi())
  ...
  public fun org.hl7.fhir.r4.model.Lipidprofile.toProto(): Lipidprofile {
    val protoValue = Lipidprofile.newBuilder()
    ...
    .setStatus(Lipidprofile.StatusCode.newBuilder().setValue(DiagnosticReportStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setResult:Cholesterol(result:Cholesterol.toProto())
    .setResult:Triglyceride(result:Triglyceride.toProto())
    .setResult:HDLCholesterol(result:HDLCholesterol.toProto())
    .setResult:LDLCholesterol(result:LDLCholesterol.toProto())
