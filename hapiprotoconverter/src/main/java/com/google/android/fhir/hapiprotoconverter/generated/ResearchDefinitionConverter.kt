...
public object ResearchDefinitionConverter {
  public fun ResearchDefinition.SubjectX.researchDefinitionSubjectToHapi(): Type {
  ...
  public fun org.hl7.fhir.r4.model.ResearchDefinition.toProto(): ResearchDefinition {
    ...
    .setStatus(ResearchDefinition.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
