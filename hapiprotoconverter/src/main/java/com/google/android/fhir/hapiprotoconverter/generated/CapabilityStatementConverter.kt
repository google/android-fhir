...
public object CapabilityStatementConverter {
  ...
  public fun org.hl7.fhir.r4.model.CapabilityStatement.toProto(): CapabilityStatement {
    ...
    .setFhirVersion(CapabilityStatement.FhirVersionCode.newBuilder().setValue(FHIRVersionCode.Value.valueOf(fhirVersion.toCode().replace("-",
        "_").toUpperCase())).build())
    .addAllFormat(format.map{CapabilityStatement.FormatCode.newBuilder().setValue(it.value).build()})
    .addAllPatchFormat(patchFormat.map{CapabilityStatement.PatchFormatCode.newBuilder().setValue(it.value).build()})
  ...
  private fun org.hl7.fhir.r4.model.CapabilityStatement.ResourceInteractionComponent.toProto():
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setCode(CapabilityStatement.Rest.Resource.ResourceInteraction.CodeType.newBuilder().setValue(TypeRestfulInteractionValueSet.Value.valueOf(code.toCode().replace("-",
        "_").toUpperCase())).build())
    .setDocumentation(documentationElement.toProto())
    .build()
    return protoValue
  ...
  private fun org.hl7.fhir.r4.model.CapabilityStatement.SystemInteractionComponent.toProto():
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setCode(CapabilityStatement.Rest.SystemInteraction.CodeType.newBuilder().setValue(SystemRestfulInteractionValueSet.Value.valueOf(code.toCode().replace("-",
        "_").toUpperCase())).build())
    .setDocumentation(documentationElement.toProto())
    .build()
    return protoValue
