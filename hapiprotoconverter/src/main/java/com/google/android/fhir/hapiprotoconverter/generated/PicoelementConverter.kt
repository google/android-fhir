...
import com.google.fhir.r4.core.Picoelement
...
public object PicoelementConverter {
  public
  ...
  public fun Picoelement.toHapi(): org.hl7.fhir.r4.model.Picoelement {
    val hapiValue = org.hl7.fhir.r4.model.Picoelement()
  ...
  public fun org.hl7.fhir.r4.model.Picoelement.toProto(): Picoelement {
    val protoValue = Picoelement.newBuilder()
    ...
    .setStatus(Picoelement.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setType(Picoelement.TypeCode.newBuilder().setValue(EvidenceVariableTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .setGroupMeasure(Picoelement.Characteristic.GroupMeasureCode.newBuilder().setValue(GroupMeasureCode.Value.valueOf(groupMeasure.toCode().replace("-",
        "_").toUpperCase())).build())
    .build()
    return protoValue
  }

  public fun EvidenceVariable.Characteristic.toHapi():
