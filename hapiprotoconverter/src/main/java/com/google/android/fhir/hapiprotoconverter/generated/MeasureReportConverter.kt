...
public object MeasureReportConverter {
  public fun MeasureReport.toHapi(): org.hl7.fhir.r4.model.MeasureReport {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.MeasureReport.MeasureReportStatus.valueOf(status.value.name.replace("_","")))
    hapiValue.setType(org.hl7.fhir.r4.model.MeasureReport.MeasureReportType.valueOf(type.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.MeasureReport.toProto(): MeasureReport {
    ...
    .setStatus(MeasureReport.StatusCode.newBuilder().setValue(MeasureReportStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    .setType(MeasureReport.TypeCode.newBuilder().setValue(MeasureReportTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.MeasureReport.MeasureReportGroupComponent.toProto():
      MeasureReport.Group {
  ...
  public fun org.hl7.fhir.r4.model.MeasureReport.MeasureReportGroupPopulationComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.MeasureReport.MeasureReportGroupStratifierComponent.toProto():
    ...
    .addAllStratifierGroup(stratifierGroup.map{it.toProto()})
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.MeasureReport.StratifierGroupComponent.toProto():
    ...
    .addAllStratifierGroupPopulation(stratifierGroupPopulation.map{it.toProto()})
    .setMeasureScore(measureScore.toProto())
    .build()
    return protoValue
  }
  ...
  public
      fun org.hl7.fhir.r4.model.MeasureReport.MeasureReportGroupStratifierStratumComponentComponent.toProto():
      MeasureReport.Group.Stratifier.Stratum.Component {
    val protoValue = MeasureReport.Group.Stratifier.Stratum.Component.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setCode(code.toProto())
  ...
  public fun org.hl7.fhir.r4.model.MeasureReport.StratifierGroupPopulationComponent.toProto():
      MeasureReport.Group.Stratifier.Stratum.StratifierGroupPopulation {
    val protoValue = MeasureReport.Group.Stratifier.Stratum.StratifierGroupPopulation.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setCode(code.toProto())
  ...
  public fun MeasureReport.Group.toHapi():
  ...
  public fun MeasureReport.Group.Population.toHapi():
  ...
  public fun MeasureReport.Group.Stratifier.toHapi():
    ...
    hapiValue.setStratifierGroup(stratifierGroupList.map{it.toHapi()})
    return hapiValue
  }

  public fun MeasureReport.Group.Stratifier.StratifierGroup.toHapi():
    ...
    hapiValue.setStratifierGroupPopulation(stratifierGroupPopulationList.map{it.toHapi()})
    hapiValue.setMeasureScore(measureScore.toHapi())
    return hapiValue
  }

  public fun MeasureReport.Group.Stratifier.Stratum.Component.toHapi():
      org.hl7.fhir.r4.model.MeasureReport.MeasureReportGroupStratifierStratumComponentComponent {
    val hapiValue =
        org.hl7.fhir.r4.model.MeasureReport.MeasureReportGroupStratifierStratumComponentComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
  ...
  public fun MeasureReport.Group.Stratifier.Stratum.StratifierGroupPopulation.toHapi():
