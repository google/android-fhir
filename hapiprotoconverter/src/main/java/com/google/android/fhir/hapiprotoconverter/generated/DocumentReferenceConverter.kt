...
public object DocumentReferenceConverter {
  public fun DocumentReference.toHapi(): org.hl7.fhir.r4.model.DocumentReference {
    ...
    hapiValue.setDocStatus(org.hl7.fhir.r4.model.DocumentReference.ReferredDocumentStatus.valueOf(docStatus.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.DocumentReference.toProto(): DocumentReference {
    ...
    .setStatus(DocumentReference.StatusCode.newBuilder().setValue(DocumentReferenceStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    .setDocStatus(DocumentReference.DocStatusCode.newBuilder().setValue(CompositionStatusCode.Value.valueOf(docStatus.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.DocumentReference.DocumentReferenceRelatesToComponent.toProto():
      DocumentReference.RelatesTo {
    val protoValue = DocumentReference.RelatesTo.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setCode(DocumentReference.RelatesTo.CodeCode.newBuilder().setValue(DocumentRelationshipTypeCode.Value.valueOf(code.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.DocumentReference.DocumentReferenceContentComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.DocumentReference.DocumentReferenceContextComponent.toProto():
  ...
  public fun DocumentReference.RelatesTo.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setCode(org.hl7.fhir.r4.model.DocumentReference.DocumentRelationshipType.valueOf(code.value.name.replace("_","")))
    hapiValue.setTarget(target.toHapi())
    return hapiValue
  }

  public fun DocumentReference.Content.toHapi():
  ...
  public fun DocumentReference.Context.toHapi():
