...
public object TestScriptConverter {
  ...
  private fun org.hl7.fhir.r4.model.TestScript.SetupActionOperationComponent.toProto():
    ...
    .setDescription(descriptionElement.toProto())
    .setAccept(TestScript.Setup.SetupAction.Operation.AcceptCode.newBuilder().setValue(accept).build())
    .setContentType(TestScript.Setup.SetupAction.Operation.ContentTypeCode.newBuilder().setValue(contentType).build())
    .setDestination(destinationElement.toProto())
    .setEncodeRequestUrl(encodeRequestUrlElement.toProto())
    .setMethod(TestScript.Setup.SetupAction.Operation.MethodCode.newBuilder().setValue(TestScriptRequestMethodCode.Value.valueOf(method.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  private fun org.hl7.fhir.r4.model.TestScript.SetupActionAssertComponent.toProto():
    ...
    .setLabel(labelElement.toProto())
    .setDescription(descriptionElement.toProto())
    .setDirection(TestScript.Setup.SetupAction.Assert.DirectionCode.newBuilder().setValue(AssertionDirectionTypeCode.Value.valueOf(direction.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setContentType(TestScript.Setup.SetupAction.Assert.ContentTypeCode.newBuilder().setValue(contentType).build())
    .setExpression(expressionElement.toProto())
    .setHeaderField(headerFieldElement.toProto())
    .setMinimumId(minimumIdElement.toProto())
    .setNavigationLinks(navigationLinksElement.toProto())
    .setOperator(TestScript.Setup.SetupAction.Assert.OperatorCode.newBuilder().setValue(AssertionOperatorTypeCode.Value.valueOf(operator.toCode().replace("-",
        "_").toUpperCase())).build())
    .setPath(pathElement.toProto())
    .setRequestMethod(TestScript.Setup.SetupAction.Assert.RequestMethodCode.newBuilder().setValue(TestScriptRequestMethodCode.Value.valueOf(requestMethod.toCode().replace("-",
        "_").toUpperCase())).build())
    .setRequestUrl(requestURLElement.toProto())
    .setResponse(TestScript.Setup.SetupAction.Assert.ResponseCode.newBuilder().setValue(AssertionResponseTypesCode.Value.valueOf(response.toCode().replace("-",
        "_").toUpperCase())).build())
