...
public object TestScriptConverter {
  ...
  public fun org.hl7.fhir.r4.model.TestScript.toProto(): TestScript {
    ...
    .setStatus(TestScript.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptOriginComponent.toProto():
      TestScript.Origin {
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptDestinationComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptMetadataComponent.toProto():
      TestScript.Metadata {
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptMetadataLinkComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptMetadataCapabilityComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptFixtureComponent.toProto():
      TestScript.Fixture {
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptVariableComponent.toProto():
      TestScript.Variable {
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptSetupComponent.toProto(): TestScript.Setup {
  ...
  public fun org.hl7.fhir.r4.model.TestScript.SetupActionComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionOperationComponent.toProto():
      TestScript.Setup.Action.Operation {
    val protoValue = TestScript.Setup.Action.Operation.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setType(type.toProto())
    .setResource(TestScript.Setup.Action.Operation.ResourceCode.newBuilder().setValue(FHIRDefinedTypeValueSet.Value.valueOf(resource.toCode().replace("-",
        "_").toUpperCase())).build())
    .setLabel(labelElement.toProto())
    .setDescription(descriptionElement.toProto())
    .setAccept(TestScript.Setup.Action.Operation.AcceptCode.newBuilder().setValue(accept).build())
    .setContentType(TestScript.Setup.Action.Operation.ContentTypeCode.newBuilder().setValue(contentType).build())
    .setDestination(destinationElement.toProto())
    .setEncodeRequestUrl(encodeRequestUrlElement.toProto())
    .setMethod(TestScript.Setup.Action.Operation.MethodCode.newBuilder().setValue(TestScriptRequestMethodCode.Value.valueOf(method.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
      fun org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionOperationRequestHeaderComponent.toProto():
      TestScript.Setup.Action.Operation.RequestHeader {
    val protoValue = TestScript.Setup.Action.Operation.RequestHeader.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionAssertComponent.toProto():
      TestScript.Setup.Action.Assert {
    val protoValue = TestScript.Setup.Action.Assert.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setLabel(labelElement.toProto())
    .setDescription(descriptionElement.toProto())
    .setDirection(TestScript.Setup.Action.Assert.DirectionCode.newBuilder().setValue(AssertionDirectionTypeCode.Value.valueOf(direction.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setContentType(TestScript.Setup.Action.Assert.ContentTypeCode.newBuilder().setValue(contentType).build())
    .setExpression(expressionElement.toProto())
    .setHeaderField(headerFieldElement.toProto())
    .setMinimumId(minimumIdElement.toProto())
    .setNavigationLinks(navigationLinksElement.toProto())
    .setOperator(TestScript.Setup.Action.Assert.OperatorCode.newBuilder().setValue(AssertionOperatorTypeCode.Value.valueOf(operator.toCode().replace("-",
        "_").toUpperCase())).build())
    .setPath(pathElement.toProto())
    .setRequestMethod(TestScript.Setup.Action.Assert.RequestMethodCode.newBuilder().setValue(TestScriptRequestMethodCode.Value.valueOf(requestMethod.toCode().replace("-",
        "_").toUpperCase())).build())
    .setRequestURL(requestURLElement.toProto())
    .setResource(TestScript.Setup.Action.Assert.ResourceCode.newBuilder().setValue(FHIRDefinedTypeValueSet.Value.valueOf(resource.toCode().replace("-",
        "_").toUpperCase())).build())
    .setResponse(TestScript.Setup.Action.Assert.ResponseCode.newBuilder().setValue(AssertionResponseTypesCode.Value.valueOf(response.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptTestComponent.toProto(): TestScript.Test {
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestActionComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TestScriptTeardownComponent.toProto():
      TestScript.Teardown {
  ...
  public fun org.hl7.fhir.r4.model.TestScript.TeardownActionComponent.toProto():
  ...
  public fun TestScript.Origin.toHapi():
  ...
  public fun TestScript.Destination.toHapi():
  ...
  public fun TestScript.Metadata.toHapi():
  ...
  public fun TestScript.Metadata.Link.toHapi():
  ...
  public fun TestScript.Metadata.Capability.toHapi():
  ...
  public fun TestScript.Fixture.toHapi():
  ...
  public fun TestScript.Variable.toHapi():
  ...
  public fun TestScript.Setup.toHapi(): org.hl7.fhir.r4.model.TestScript.TestScriptSetupComponent {
  ...
  public fun TestScript.Setup.SetupAction.toHapi():
  ...
  public fun TestScript.Setup.Action.Operation.toHapi():
      org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionOperationComponent {
    val hapiValue = org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionOperationComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setType(type.toHapi())
    hapiValue.setResource(Enumerations.FHIRDefinedType.valueOf(resource.value.name.replace("_","")))
    ...
    hapiValue.setMethod(org.hl7.fhir.r4.model.TestScript.TestScriptRequestMethodCode.valueOf(method.value.name.replace("_","")))
  ...
  public fun TestScript.Setup.Action.Operation.RequestHeader.toHapi():
      org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionOperationRequestHeaderComponent {
    val hapiValue =
        org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionOperationRequestHeaderComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
  ...
  public fun TestScript.Setup.Action.Assert.toHapi():
      org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionAssertComponent {
    val hapiValue = org.hl7.fhir.r4.model.TestScript.TestScriptSetupActionAssertComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setLabelElement(label.toHapi())
    hapiValue.setDescriptionElement(description.toHapi())
    hapiValue.setDirection(org.hl7.fhir.r4.model.TestScript.AssertionDirectionType.valueOf(direction.value.name.replace("_","")))
    ...
    hapiValue.setOperator(org.hl7.fhir.r4.model.TestScript.AssertionOperatorType.valueOf(operator.value.name.replace("_","")))
    hapiValue.setPathElement(path.toHapi())
    hapiValue.setRequestMethod(org.hl7.fhir.r4.model.TestScript.TestScriptRequestMethodCode.valueOf(requestMethod.value.name.replace("_","")))
    hapiValue.setRequestURLElement(requestURL.toHapi())
    hapiValue.setResource(Enumerations.FHIRDefinedType.valueOf(resource.value.name.replace("_","")))
    hapiValue.setResponse(org.hl7.fhir.r4.model.TestScript.AssertionResponseTypes.valueOf(response.value.name.replace("_","")))
  ...
  public fun TestScript.Test.toHapi(): org.hl7.fhir.r4.model.TestScript.TestScriptTestComponent {
  ...
  public fun TestScript.Test.TestAction.toHapi():
  ...
  public fun TestScript.Teardown.toHapi():
  ...
  public fun TestScript.Teardown.TeardownAction.toHapi():
