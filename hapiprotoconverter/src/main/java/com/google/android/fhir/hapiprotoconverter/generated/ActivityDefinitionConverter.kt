...
public object ActivityDefinitionConverter {
  ...
  public fun org.hl7.fhir.r4.model.ActivityDefinition.toProto(): ActivityDefinition {
    ...
    .setStatus(ActivityDefinition.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setKind(ActivityDefinition.KindCode.newBuilder().setValue(RequestResourceTypeCode.Value.valueOf(kind.toCode().replace("-",
        "_").toUpperCase())).build())
    .setProfile(profileElement.toProto())
    .setCode(code.toProto())
    .setIntent(ActivityDefinition.IntentCode.newBuilder().setValue(RequestIntentCode.Value.valueOf(intent.toCode().replace("-",
        "_").toUpperCase())).build())
    .setPriority(ActivityDefinition.PriorityCode.newBuilder().setValue(RequestPriorityCode.Value.valueOf(priority.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setType(ActivityDefinition.Participant.TypeCode.newBuilder().setValue(ActionParticipantTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
