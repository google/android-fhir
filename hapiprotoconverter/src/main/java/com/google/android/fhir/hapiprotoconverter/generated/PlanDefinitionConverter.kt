...
public object PlanDefinitionConverter {
  ...
  public fun org.hl7.fhir.r4.model.PlanDefinition.toProto(): PlanDefinition {
    ...
    .setStatus(PlanDefinition.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.PlanDefinition.PlanDefinitionActionComponent.toProto():
    ...
    .setPriority(PlanDefinition.Action.PriorityCode.newBuilder().setValue(RequestPriorityCode.Value.valueOf(priority.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setType(type.toProto())
    .setGroupingBehavior(PlanDefinition.Action.GroupingBehaviorCode.newBuilder().setValue(ActionGroupingBehaviorCode.Value.valueOf(groupingBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
    .setSelectionBehavior(PlanDefinition.Action.SelectionBehaviorCode.newBuilder().setValue(ActionSelectionBehaviorCode.Value.valueOf(selectionBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
    .setRequiredBehavior(PlanDefinition.Action.RequiredBehaviorCode.newBuilder().setValue(ActionRequiredBehaviorCode.Value.valueOf(requiredBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
    .setPrecheckBehavior(PlanDefinition.Action.PrecheckBehaviorCode.newBuilder().setValue(ActionPrecheckBehaviorCode.Value.valueOf(precheckBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
    .setCardinalityBehavior(PlanDefinition.Action.CardinalityBehaviorCode.newBuilder().setValue(ActionCardinalityBehaviorCode.Value.valueOf(cardinalityBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.PlanDefinition.PlanDefinitionActionConditionComponent.toProto():
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setKind(PlanDefinition.Action.Condition.KindCode.newBuilder().setValue(ActionConditionKindCode.Value.valueOf(kind.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .setRelationship(PlanDefinition.Action.RelatedAction.RelationshipCode.newBuilder().setValue(ActionRelationshipTypeCode.Value.valueOf(relationship.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setType(PlanDefinition.Action.Participant.TypeCode.newBuilder().setValue(ActionParticipantTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
