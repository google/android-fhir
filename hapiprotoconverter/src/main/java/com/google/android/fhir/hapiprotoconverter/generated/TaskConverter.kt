...
public object TaskConverter {
  ...
  public fun Task.Output.ValueX.taskOutputValueToHapi(): Type {
    if (this.getBase64Binary() != Base64Binary.newBuilder().defaultInstanceForType ) {
      return (this.getBase64Binary()).toHapi()
    }
    if (this.getBoolean() != Boolean.newBuilder().defaultInstanceForType ) {
  ...
  public fun org.hl7.fhir.r4.model.Task.TaskRestrictionComponent.toProto(): Task.Restriction {
  ...
  public fun org.hl7.fhir.r4.model.Task.ParameterComponent.toProto(): Task.Parameter {
  ...
  public fun org.hl7.fhir.r4.model.Task.TaskOutputComponent.toProto(): Task.Output {
  ...
  public fun Task.Restriction.toHapi(): org.hl7.fhir.r4.model.Task.TaskRestrictionComponent {
  ...
  public fun Task.Parameter.toHapi(): org.hl7.fhir.r4.model.Task.ParameterComponent {
  ...
  public fun Task.Output.toHapi(): org.hl7.fhir.r4.model.Task.TaskOutputComponent {
