...
public object BundleConverter {
  public fun Bundle.toHapi(): org.hl7.fhir.r4.model.Bundle {
    ...
    hapiValue.setType(org.hl7.fhir.r4.model.Bundle.BundleType.valueOf(type.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.Bundle.toProto(): Bundle {
    ...
    .setType(Bundle.TypeCode.newBuilder().setValue(BundleTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.Bundle.BundleLinkComponent.toProto(): Bundle.Link {
  ...
  public fun org.hl7.fhir.r4.model.Bundle.BundleEntryComponent.toProto(): Bundle.Entry {
  ...
  public fun org.hl7.fhir.r4.model.Bundle.BundleEntrySearchComponent.toProto():
      Bundle.Entry.Search {
    val protoValue = Bundle.Entry.Search.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setMode(Bundle.Entry.Search.ModeCode.newBuilder().setValue(SearchEntryModeCode.Value.valueOf(mode.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.Bundle.BundleEntryRequestComponent.toProto():
      Bundle.Entry.Request {
    val protoValue = Bundle.Entry.Request.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setMethod(Bundle.Entry.Request.MethodCode.newBuilder().setValue(HTTPVerbCode.Value.valueOf(method.toCode().replace("-",
        "_").toUpperCase())).build())
    .setUrl(urlElement.toProto())
  ...
  public fun org.hl7.fhir.r4.model.Bundle.BundleEntryResponseComponent.toProto():
  ...
  public fun Bundle.Link.toHapi(): org.hl7.fhir.r4.model.Bundle.BundleLinkComponent {
  ...
  public fun Bundle.Entry.toHapi(): org.hl7.fhir.r4.model.Bundle.BundleEntryComponent {
  ...
  public fun Bundle.Entry.Search.toHapi(): org.hl7.fhir.r4.model.Bundle.BundleEntrySearchComponent {
    val hapiValue = org.hl7.fhir.r4.model.Bundle.BundleEntrySearchComponent()
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setMode(org.hl7.fhir.r4.model.Bundle.SearchEntryMode.valueOf(mode.value.name.replace("_","")))
    hapiValue.setScoreElement(score.toHapi())
    return hapiValue
  }

  public fun Bundle.Entry.Request.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setMethod(org.hl7.fhir.r4.model.Bundle.HTTPVerb.valueOf(method.value.name.replace("_","")))
    hapiValue.setUrlElement(url.toHapi())
  ...
  public fun Bundle.Entry.Response.toHapi():
