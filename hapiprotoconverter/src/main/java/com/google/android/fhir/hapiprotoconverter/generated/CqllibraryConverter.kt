...
import com.google.fhir.r4.core.Cqllibrary
...
public object CqllibraryConverter {
  ...
  public fun Cqllibrary.toHapi(): org.hl7.fhir.r4.model.Cqllibrary {
    val hapiValue = org.hl7.fhir.r4.model.Cqllibrary()
  ...
  public fun org.hl7.fhir.r4.model.Cqllibrary.toProto(): Cqllibrary {
    val protoValue = Cqllibrary.newBuilder()
    ...
    .setStatus(Cqllibrary.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
