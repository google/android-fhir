...
public object EnrollmentResponseConverter {
  public fun EnrollmentResponse.toHapi(): org.hl7.fhir.r4.model.EnrollmentResponse {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.EnrollmentResponse.EnrollmentResponseStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.EnrollmentResponse.toProto(): EnrollmentResponse {
    ...
    .setStatus(EnrollmentResponse.StatusCode.newBuilder().setValue(FinancialResourceStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    .setRequest(request.toProto())
    .setOutcome(EnrollmentResponse.OutcomeCode.newBuilder().setValue(ClaimProcessingCode.Value.valueOf(outcome.toCode().replace("-",
        "_").toUpperCase())).build())
