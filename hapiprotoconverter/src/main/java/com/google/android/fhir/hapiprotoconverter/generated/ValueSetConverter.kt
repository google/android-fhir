...
public object ValueSetConverter {
  ...
  public fun org.hl7.fhir.r4.model.ValueSet.toProto(): ValueSet {
    ...
    .setStatus(ValueSet.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  private fun org.hl7.fhir.r4.model.ValueSet.ConceptSetFilterComponent.toProto():
    ...
    .setOp(ValueSet.Compose.ConceptSet.Filter.OpCode.newBuilder().setValue(FilterOperatorCode.Value.valueOf(op.toCode().replace("-",
        "_").toUpperCase())).build())
    .setValue(valueElement.toProto())
    .build()
    return protoValue
