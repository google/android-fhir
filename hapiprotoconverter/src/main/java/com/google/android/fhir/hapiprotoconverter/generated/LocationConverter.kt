...
public object LocationConverter {
  public fun Location.toHapi(): org.hl7.fhir.r4.model.Location {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.Location.LocationStatus.valueOf(status.value.name.replace("_","")))
    hapiValue.setOperationalStatus(operationalStatus.toHapi())
    hapiValue.setNameElement(name.toHapi())
    hapiValue.setAlias(aliasList.map{it.toHapi()})
    hapiValue.setDescriptionElement(description.toHapi())
    hapiValue.setMode(org.hl7.fhir.r4.model.Location.LocationMode.valueOf(mode.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.Location.toProto(): Location {
    ...
    .setStatus(Location.StatusCode.newBuilder().setValue(LocationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    .setOperationalStatus(operationalStatus.toProto())
    .setName(nameElement.toProto())
    .addAllAlias(alias.map{it.toProto()})
    .setDescription(descriptionElement.toProto())
    .setMode(Location.ModeCode.newBuilder().setValue(LocationModeCode.Value.valueOf(mode.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.Location.LocationPositionComponent.toProto(): Location.Position {
  ...
  public fun org.hl7.fhir.r4.model.Location.LocationHoursOfOperationComponent.toProto():
      Location.HoursOfOperation {
    val protoValue = Location.HoursOfOperation.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .addAllDaysOfWeek(daysOfWeek.map{Location.HoursOfOperation.DaysOfWeekCode.newBuilder().setValue(DaysOfWeekCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
  ...
  public fun Location.Position.toHapi(): org.hl7.fhir.r4.model.Location.LocationPositionComponent {
  ...
  public fun Location.HoursOfOperation.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    daysOfWeekList.map{hapiValue.addDaysOfWeek(org.hl7.fhir.r4.model.Location.DaysOfWeek.valueOf(it.value.name.replace("_","")))}
