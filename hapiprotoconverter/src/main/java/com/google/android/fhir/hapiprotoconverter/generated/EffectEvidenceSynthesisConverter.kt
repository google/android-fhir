...
public object EffectEvidenceSynthesisConverter {
  ...
  public fun org.hl7.fhir.r4.model.EffectEvidenceSynthesis.toProto(): EffectEvidenceSynthesis {
    ...
    .setStatus(EffectEvidenceSynthesis.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setDescription(descriptionElement.toProto())
    .setExposureState(EffectEvidenceSynthesis.ResultsByExposure.ExposureStateCode.newBuilder().setValue(ExposureStateCode.Value.valueOf(exposureState.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun EffectEvidenceSynthesis.SampleSize.toHapi():
  ...
  public fun EffectEvidenceSynthesis.ResultsByExposure.toHapi():
    ...
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setDescriptionElement(description.toHapi())
    hapiValue.setExposureState(org.hl7.fhir.r4.model.EffectEvidenceSynthesis.ExposureState.valueOf(exposureState.value.name.replace("_","")))
    hapiValue.setVariantState(variantState.toHapi())
    hapiValue.setRiskEvidenceSynthesis(riskEvidenceSynthesis.toHapi())
    return hapiValue
  }

  public fun EffectEvidenceSynthesis.EffectEstimate.toHapi():
  ...
  public fun EffectEvidenceSynthesis.EffectEstimate.PrecisionEstimate.toHapi():
  ...
  public fun EffectEvidenceSynthesis.Certainty.toHapi():
  ...
  public fun EffectEvidenceSynthesis.Certainty.CertaintySubcomponent.toHapi():
