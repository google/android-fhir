...
public object MedicationDispenseConverter {
  public fun MedicationDispense.StatusReasonX.medicationDispenseStatusReasonToHapi(): Type {
  ...
  public fun MedicationDispense.MedicationX.medicationDispenseMedicationToHapi(): Type {
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
      return (this.getCodeableConcept()).toHapi()
    }
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
  ...
  public fun MedicationDispense.toHapi(): org.hl7.fhir.r4.model.MedicationDispense {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.MedicationDispense.MedicationDispenseStatus.valueOf(status.value.name.replace("_","")))
  ...
  public fun org.hl7.fhir.r4.model.MedicationDispense.toProto(): MedicationDispense {
    ...
    .setStatus(MedicationDispense.StatusCode.newBuilder().setValue(MedicationDispenseStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun MedicationDispense.Performer.toHapi():
  ...
  public fun MedicationDispense.Substitution.toHapi():
