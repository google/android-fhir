...
public object ContractConverter {
  public fun Contract.TopicX.contractTopicToHapi(): Type {
  ...
  public fun Contract.Term.TopicX.contractTermTopicToHapi(): Type {
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
      return (this.getCodeableConcept()).toHapi()
    }
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
  ...
  public fun Contract.Term.Offer.Answer.ValueX.contractTermOfferAnswerValueToHapi(): Type {
  ...
  public fun Type.contractTermOfferAnswerValueToProto(): Contract.Term.Offer.Answer.ValueX {
    val protoValue = Contract.Term.Offer.Answer.ValueX.newBuilder()
  ...
  public fun Contract.Term.Asset.ValuedItem.EntityX.contractTermAssetValuedItemEntityToHapi():
      Type {
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
      return (this.getCodeableConcept()).toHapi()
    }
  ...
  public fun Type.contractTermAssetValuedItemEntityToProto():
      Contract.Term.Asset.ValuedItem.EntityX {
    val protoValue = Contract.Term.Asset.ValuedItem.EntityX.newBuilder()
    if (this is org.hl7.fhir.r4.model.CodeableConcept) {
      protoValue.setCodeableConcept(this.toProto())
    }
    if (this is org.hl7.fhir.r4.model.Reference) {
  ...
  public fun Contract.Term.Action.OccurrenceX.contractTermActionOccurrenceToHapi(): Type {
    if (this.getDateTime() != DateTime.newBuilder().defaultInstanceForType ) {
      return (this.getDateTime()).toHapi()
    }
  ...
  public fun Contract.Friendly.ContentX.contractFriendlyContentToHapi(): Type {
    if (this.getAttachment() != Attachment.newBuilder().defaultInstanceForType ) {
      return (this.getAttachment()).toHapi()
    }
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
  ...
  public fun Type.contractFriendlyContentToProto(): Contract.Friendly.ContentX {
    val protoValue = Contract.Friendly.ContentX.newBuilder()
    if (this is org.hl7.fhir.r4.model.Attachment) {
      protoValue.setAttachment(this.toProto())
    }
    if (this is org.hl7.fhir.r4.model.Reference) {
  ...
  public fun Contract.Legal.ContentX.contractLegalContentToHapi(): Type {
    if (this.getAttachment() != Attachment.newBuilder().defaultInstanceForType ) {
      return (this.getAttachment()).toHapi()
    }
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
  ...
  public fun Type.contractLegalContentToProto(): Contract.Legal.ContentX {
    val protoValue = Contract.Legal.ContentX.newBuilder()
    if (this is org.hl7.fhir.r4.model.Attachment) {
      protoValue.setAttachment(this.toProto())
    }
    if (this is org.hl7.fhir.r4.model.Reference) {
  ...
  public fun Contract.Rule.ContentX.contractRuleContentToHapi(): Type {
    if (this.getAttachment() != Attachment.newBuilder().defaultInstanceForType ) {
      return (this.getAttachment()).toHapi()
    }
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
  ...
  public fun Type.contractRuleContentToProto(): Contract.Rule.ContentX {
    val protoValue = Contract.Rule.ContentX.newBuilder()
    if (this is org.hl7.fhir.r4.model.Attachment) {
      protoValue.setAttachment(this.toProto())
    }
    if (this is org.hl7.fhir.r4.model.Reference) {
  ...
  public fun Contract.LegallyBindingX.contractLegallyBindingToHapi(): Type {
    if (this.getAttachment() != Attachment.newBuilder().defaultInstanceForType ) {
      return (this.getAttachment()).toHapi()
    }
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
  ...
  public fun Contract.toHapi(): org.hl7.fhir.r4.model.Contract {
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.Contract.ContractStatus.valueOf(status.value.name.replace("_","")))
    ...
    hapiValue.setSignatory(signatoryList.map{it.toHapi()})
    hapiValue.setFriendlyLanguage(friendlyLanguageList.map{it.toHapi()})
    hapiValue.setLegalLanguage(legalLanguageList.map{it.toHapi()})
    hapiValue.setComputableLanguage(computableLanguageList.map{it.toHapi()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.toProto(): Contract {
    ...
    .setStatus(Contract.StatusCode.newBuilder().setValue(ContractResourceStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .addAllSignatory(signatory.map{it.toProto()})
    .addAllFriendlyLanguage(friendlyLanguage.map{it.toProto()})
    .addAllLegalLanguage(legalLanguage.map{it.toProto()})
    .addAllComputableLanguage(computableLanguage.map{it.toProto()})
    .setLegallyBinding(legallyBinding.contractLegallyBindingToProto())
    .build()
    return protoValue
  }

  public fun org.hl7.fhir.r4.model.Contract.ContentDefinitionComponent.toProto():
    ...
    .setPublicationStatus(Contract.ContentDefinition.PublicationStatusCode.newBuilder().setValue(ContractResourcePublicationStatusCode.Value.valueOf(publicationStatus.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.Contract.TermComponent.toProto(): Contract.Term {
    ...
    .setContractOffer(contractOffer.toProto())
    .addAllContractAsset(contractAsset.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.SecurityLabelComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.Contract.ContractOfferComponent.toProto():
    ...
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .addAllIdentifier(identifier.map{it.toProto()})
    .addAllContractParty(contractParty.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.ContractPartyComponent.toProto():
      Contract.Term.Offer.ContractParty {
    val protoValue = Contract.Term.Offer.ContractParty.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.AnswerComponent.toProto(): Contract.Term.Offer.Answer {
    val protoValue = Contract.Term.Offer.Answer.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.ContractAssetComponent.toProto():
    ...
    .addAllAssetContext(assetContext.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.AssetContextComponent.toProto():
      Contract.Term.Asset.AssetContext {
    val protoValue = Contract.Term.Asset.AssetContext.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.ValuedItemComponent.toProto():
      Contract.Term.Asset.ValuedItem {
    val protoValue = Contract.Term.Asset.ValuedItem.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.ActionComponent.toProto(): Contract.Term.Action {
    ...
    .setType(type.toProto())
    .addAllActionSubject(actionSubject.map{it.toProto()})
  ...
  public fun org.hl7.fhir.r4.model.Contract.ActionSubjectComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.Contract.SignatoryComponent.toProto(): Contract.Signatory {
  ...
  public fun org.hl7.fhir.r4.model.Contract.FriendlyLanguageComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.Contract.LegalLanguageComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.Contract.ComputableLanguageComponent.toProto():
  ...
  public fun Contract.ContentDefinition.toHapi():
    ...
    hapiValue.setPublicationStatus(org.hl7.fhir.r4.model.Contract.ContractPublicationStatus.valueOf(publicationStatus.value.name.replace("_","")))
    hapiValue.setCopyrightElement(copyright.toHapi())
    return hapiValue
  }

  public fun Contract.Term.toHapi(): org.hl7.fhir.r4.model.Contract.TermComponent {
    ...
    hapiValue.setContractOffer(contractOffer.toHapi())
    hapiValue.setContractAsset(contractAssetList.map{it.toHapi()})
    hapiValue.setAction(actionList.map{it.toHapi()})
    hapiValue.setGroup(groupList.map{it.toHapi()})
    return hapiValue
  }

  public fun Contract.Term.SecurityLabel.toHapi():
  ...
  public fun Contract.Term.ContractOffer.toHapi():
    ...
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setIdentifier(identifierList.map{it.toHapi()})
    hapiValue.setContractParty(contractPartyList.map{it.toHapi()})
  ...
  public fun Contract.Term.Offer.ContractParty.toHapi():
  ...
  public fun Contract.Term.Offer.Answer.toHapi(): org.hl7.fhir.r4.model.Contract.AnswerComponent {
  ...
  public fun Contract.Term.ContractAsset.toHapi():
    ...
    hapiValue.setAssetContext(assetContextList.map{it.toHapi()})
  ...
  public fun Contract.Term.Asset.AssetContext.toHapi():
  ...
  public fun Contract.Term.Asset.ValuedItem.toHapi():
  ...
  public fun Contract.Term.Action.toHapi(): org.hl7.fhir.r4.model.Contract.ActionComponent {
    ...
    hapiValue.setType(type.toHapi())
    hapiValue.setActionSubject(actionSubjectList.map{it.toHapi()})
  ...
  public fun Contract.Term.Action.ActionSubject.toHapi():
  ...
  public fun Contract.Signatory.toHapi(): org.hl7.fhir.r4.model.Contract.SignatoryComponent {
  ...
  public fun Contract.FriendlyLanguage.toHapi():
  ...
  public fun Contract.LegalLanguage.toHapi():
  ...
  public fun Contract.ComputableLanguage.toHapi():
