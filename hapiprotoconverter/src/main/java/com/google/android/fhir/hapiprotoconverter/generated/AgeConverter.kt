...
object AgeConverter {
  @JvmStatic
  fun Age.toHapi(): org.hl7.fhir.r4.model.Age {
  ...
  @JvmStatic
  fun org.hl7.fhir.r4.model.Age.toProto(): Age {
    val protoValue = Age.newBuilder().setId(String.newBuilder().setValue(id))
    if (hasExtension()) {
    ...
    if (hasValue()) {
      ...
      protoValue.comparator = Age.ComparatorCode.newBuilder()
          .setValue(
