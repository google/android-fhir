...
object SpecimenDefinitionConverter {
  ...
  private fun org.hl7.fhir.r4.model.SpecimenDefinition.SpecimenDefinitionTypeTestedComponent.toProto():
    ...
    if (hasType()) {
      ...
      protoValue.preference = SpecimenDefinition.TypeTested.PreferenceCode.newBuilder()
          .setValue(
  ...
  private fun org.hl7.fhir.r4.model.SpecimenDefinition.SpecimenDefinitionTypeTestedContainerComponent.toProto():
    ...
    if (hasMinimumVolume()) {
        protoValue.minimumVolume = minimumVolume.specimenDefinitionTypeTestedContainerMinimumVolumeToProto()
    }
    if (hasAdditive()) {
  ...
  private fun SpecimenDefinition.TypeTested.toHapi():
    ...
    if (hasType()) {
      ...
      hapiValue.preference = org.hl7.fhir.r4.model.SpecimenDefinition.SpecimenContainedPreference.valueOf(
  ...
  private fun SpecimenDefinition.TypeTested.Container.toHapi():
    ...
    if (hasMinimumVolume()) {
        hapiValue.minimumVolume = minimumVolume.specimenDefinitionTypeTestedContainerMinimumVolumeToHapi()
    }
    if (additiveCount > 0) {
