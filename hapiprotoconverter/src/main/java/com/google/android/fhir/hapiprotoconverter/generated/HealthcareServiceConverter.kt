...
public object HealthcareServiceConverter {
  ...
  public
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .addAllDaysOfWeek(daysOfWeek.map{HealthcareService.AvailableTime.DaysOfWeekCode.newBuilder().setValue(DaysOfWeekCode.Value.valueOf(it.value.toCode().replace("-",
        "_").toUpperCase())).build()})
  ...
  public fun HealthcareService.Eligibility.toHapi():
  ...
  public fun HealthcareService.AvailableTime.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    daysOfWeekList.map{hapiValue.addDaysOfWeek(org.hl7.fhir.r4.model.HealthcareService.DaysOfWeek.valueOf(it.value.name.replace("_","")))}
  ...
  public fun HealthcareService.NotAvailable.toHapi():
