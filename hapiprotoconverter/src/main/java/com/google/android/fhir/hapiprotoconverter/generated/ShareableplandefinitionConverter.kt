...
import com.google.fhir.r4.core.Shareableplandefinition
...
public object ShareableplandefinitionConverter {
  public fun PlanDefinition.SubjectX.planDefinitionSubjectToHapi(): Type {
  ...
  public fun PlanDefinition.Goal.Target.DetailX.planDefinitionGoalTargetDetailToHapi(): Type {
  ...
  public fun PlanDefinition.Action.SubjectX.planDefinitionActionSubjectToHapi(): Type {
    if (this.getCodeableConcept() != CodeableConcept.newBuilder().defaultInstanceForType ) {
      return (this.getCodeableConcept()).toHapi()
    }
    if (this.getReference() != Reference.newBuilder().defaultInstanceForType ) {
  ...
  public fun PlanDefinition.Action.TimingX.planDefinitionActionTimingToHapi(): Type {
  ...
  public fun PlanDefinition.Action.DefinitionX.planDefinitionActionDefinitionToHapi(): Type {
  ...
  public fun Shareableplandefinition.toHapi(): org.hl7.fhir.r4.model.Shareableplandefinition {
    val hapiValue = org.hl7.fhir.r4.model.Shareableplandefinition()
  ...
  public fun org.hl7.fhir.r4.model.Shareableplandefinition.toProto(): Shareableplandefinition {
    val protoValue = Shareableplandefinition.newBuilder()
    ...
    .setStatus(Shareableplandefinition.StatusCode.newBuilder().setValue(PublicationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.PlanDefinition.PlanDefinitionGoalComponent.toProto():
      PlanDefinition.Goal {
  ...
  public fun org.hl7.fhir.r4.model.PlanDefinition.PlanDefinitionGoalTargetComponent.toProto():
  ...
  public fun org.hl7.fhir.r4.model.PlanDefinition.PlanDefinitionActionComponent.toProto():
    ...
    .setPriority(Shareableplandefinition.Action.PriorityCode.newBuilder().setValue(RequestPriorityCode.Value.valueOf(priority.toCode().replace("-",
        "_").toUpperCase())).build())
    ...
    .setType(type.toProto())
    .setGroupingBehavior(Shareableplandefinition.Action.GroupingBehaviorCode.newBuilder().setValue(ActionGroupingBehaviorCode.Value.valueOf(groupingBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
    .setSelectionBehavior(Shareableplandefinition.Action.SelectionBehaviorCode.newBuilder().setValue(ActionSelectionBehaviorCode.Value.valueOf(selectionBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
    .setRequiredBehavior(Shareableplandefinition.Action.RequiredBehaviorCode.newBuilder().setValue(ActionRequiredBehaviorCode.Value.valueOf(requiredBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
    .setPrecheckBehavior(Shareableplandefinition.Action.PrecheckBehaviorCode.newBuilder().setValue(ActionPrecheckBehaviorCode.Value.valueOf(precheckBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
    .setCardinalityBehavior(Shareableplandefinition.Action.CardinalityBehaviorCode.newBuilder().setValue(ActionCardinalityBehaviorCode.Value.valueOf(cardinalityBehavior.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun org.hl7.fhir.r4.model.PlanDefinition.PlanDefinitionActionConditionComponent.toProto():
      PlanDefinition.Action.Condition {
    val protoValue = PlanDefinition.Action.Condition.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setKind(Shareableplandefinition.Action.Condition.KindCode.newBuilder().setValue(ActionConditionKindCode.Value.valueOf(kind.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .setRelationship(Shareableplandefinition.Action.RelatedAction.RelationshipCode.newBuilder().setValue(ActionRelationshipTypeCode.Value.valueOf(relationship.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setType(Shareableplandefinition.Action.Participant.TypeCode.newBuilder().setValue(ActionParticipantTypeCode.Value.valueOf(type.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun PlanDefinition.Goal.toHapi():
  ...
  public fun PlanDefinition.Goal.Target.toHapi():
  ...
  public fun PlanDefinition.Action.toHapi():
    ...
    hapiValue.setPriority(org.hl7.fhir.r4.model.PlanDefinition.RequestPriority.valueOf(priority.value.name.replace("_","")))
    ...
    hapiValue.setType(type.toHapi())
    hapiValue.setGroupingBehavior(org.hl7.fhir.r4.model.PlanDefinition.ActionGroupingBehavior.valueOf(groupingBehavior.value.name.replace("_","")))
    hapiValue.setSelectionBehavior(org.hl7.fhir.r4.model.PlanDefinition.ActionSelectionBehavior.valueOf(selectionBehavior.value.name.replace("_","")))
    hapiValue.setRequiredBehavior(org.hl7.fhir.r4.model.PlanDefinition.ActionRequiredBehavior.valueOf(requiredBehavior.value.name.replace("_","")))
    hapiValue.setPrecheckBehavior(org.hl7.fhir.r4.model.PlanDefinition.ActionPrecheckBehavior.valueOf(precheckBehavior.value.name.replace("_","")))
    hapiValue.setCardinalityBehavior(org.hl7.fhir.r4.model.PlanDefinition.ActionCardinalityBehavior.valueOf(cardinalityBehavior.value.name.replace("_","")))
  ...
  public fun PlanDefinition.Action.Condition.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setKind(org.hl7.fhir.r4.model.PlanDefinition.ActionConditionKind.valueOf(kind.value.name.replace("_","")))
    hapiValue.setExpression(expression.toHapi())
    return hapiValue
  }

  public fun PlanDefinition.Action.RelatedAction.toHapi():
    ...
    hapiValue.setRelationship(org.hl7.fhir.r4.model.PlanDefinition.ActionRelationshipType.valueOf(relationship.value.name.replace("_","")))
    hapiValue.setOffset(offset.planDefinitionActionRelatedActionOffsetToHapi())
    return hapiValue
  }

  public fun PlanDefinition.Action.Participant.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setType(org.hl7.fhir.r4.model.PlanDefinition.ActionParticipantType.valueOf(type.value.name.replace("_","")))
    hapiValue.setRole(role.toHapi())
    return hapiValue
  }

  public fun PlanDefinition.Action.DynamicValue.toHapi():
