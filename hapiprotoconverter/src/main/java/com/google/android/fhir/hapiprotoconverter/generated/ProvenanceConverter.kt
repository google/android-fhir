...
public object ProvenanceConverter {
  public fun Provenance.OccurredX.provenanceOccurredToHapi(): Type {
  ...
  public fun org.hl7.fhir.r4.model.Provenance.ProvenanceAgentComponent.toProto(): Provenance.Agent {
  ...
  public fun org.hl7.fhir.r4.model.Provenance.ProvenanceEntityComponent.toProto():
      Provenance.Entity {
    val protoValue = Provenance.Entity.newBuilder()
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .addAllModifierExtension(modifierExtension.map{it.toProto()})
    .setRole(Provenance.Entity.RoleCode.newBuilder().setValue(ProvenanceEntityRoleCode.Value.valueOf(role.toCode().replace("-",
        "_").toUpperCase())).build())
  ...
  public fun Provenance.Agent.toHapi(): org.hl7.fhir.r4.model.Provenance.ProvenanceAgentComponent {
  ...
  public fun Provenance.Entity.toHapi():
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setModifierExtension(modifierExtensionList.map{it.toHapi()})
    hapiValue.setRole(org.hl7.fhir.r4.model.Provenance.ProvenanceEntityRole.valueOf(role.value.name.replace("_","")))
