...
import com.google.fhir.r4.core.Vitalspanel
...
public object VitalspanelConverter {
  ...
  public fun Vitalspanel.toHapi(): org.hl7.fhir.r4.model.Vitalspanel {
    val hapiValue = org.hl7.fhir.r4.model.Vitalspanel()
    ...
    hapiValue.setStatus(org.hl7.fhir.r4.model.Observation.Status.valueOf(status.value.name.replace("_","")))
    hapiValue.setCategory(categoryList.map{it.toHapi()})
    hapiValue.setCategory:VSCat(category:VSCat.toHapi())
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    ...
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setCoding(codingList.map{it.toHapi()})
    hapiValue.setCoding:VitalsPanelCode(coding:VitalsPanelCodeList.map{it.toHapi()})
    hapiValue.id = id.value 
    hapiValue.setExtension(extensionList.map{it.toHapi()})
    hapiValue.setSystemElement(system.toHapi())
    hapiValue.setVersionElement(version.toHapi())
  ...
  public fun org.hl7.fhir.r4.model.Vitalspanel.toProto(): Vitalspanel {
    val protoValue = Vitalspanel.newBuilder()
    ...
    .setStatus(Vitalspanel.StatusCode.newBuilder().setValue(ObservationStatusCode.Value.valueOf(status.toCode().replace("-",
        "_").toUpperCase())).build())
    .addAllCategory(category.map{it.toProto()})
    .setCategory:VSCat(category:VSCat.toProto())
    ...
    .addAllExtension(extension.map{it.toProto()})
    .addAllCoding(coding.map{it.toProto()})
    .addAllCoding:VitalsPanelCode(coding:VitalsPanelCode.map{it.toProto()})
    .setId(String.newBuilder().setValue(id))
    .addAllExtension(extension.map{it.toProto()})
    .setSystem(systemElement.toProto())
    .setVersion(versionElement.toProto())
