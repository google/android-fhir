...
public class IdConverterTest(private val hapi: IdType, private val proto: Id) {
  @Test
  public fun hapi() {
  ...
  public companion object {
    @Parameterized.Parameters @JvmStatic public fun `data`(): List<Any> = PrimitiveTestData.ID_DATA
  }
}
