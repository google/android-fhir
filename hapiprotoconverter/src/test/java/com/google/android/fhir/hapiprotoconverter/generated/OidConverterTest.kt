...
public class OidConverterTest(private val hapi: OidType, private val proto: Oid) {
  @Test
  public fun hapi() {
  ...
  public companion object {
    @Parameterized.Parameters @JvmStatic public fun `data`(): List<Any> = PrimitiveTestData.OID_DATA
  }
}
