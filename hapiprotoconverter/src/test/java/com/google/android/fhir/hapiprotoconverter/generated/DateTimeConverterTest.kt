...
class DateTimeConverterTest(private val hapi: DateTimeType, private val proto: DateTime) {
  @Test
  fun hapi() {
  ...
  companion object {
    @Parameterized.Parameters @JvmStatic fun `data`(): List<Any> = PrimitiveTestData.DATETIME_DATA
  }
}
