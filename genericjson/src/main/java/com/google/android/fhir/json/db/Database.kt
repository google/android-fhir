...
internal interface Database {
   ...
   */
  suspend fun <R : JsonResource> insert(vararg resource: R): List<String>
   ...
   * @param <R> The resource type
   */
  suspend fun <R : JsonResource> insertRemote(vararg resource: R)
   ...
   * @param <R> The resource type
   */
  suspend fun update(vararg resources: JsonResource)
  ...
  suspend fun select(type: String, id: String): JsonResource

  /**
   * Selects the saved `JsonResourceEntity` of type `clazz` with `id`.
   *
   * @param <R> The resource type
   * @throws ResourceNotFoundException if the resource is not found in the database
   */
  @Throws(ResourceNotFoundException::class)
  suspend fun selectEntity(type: String, id: String): JsonResourceEntity
  ...
  suspend fun deleteUpdates(resources: List<JsonResource>)
