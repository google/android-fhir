...
package com.google.android.fhir.r4.sync.upload
...
import com.google.android.fhir.r4.sync.Uploader
...
internal class R4BundleUploader(
  ...
  override suspend fun upload(
    ...
    bundleGenerator.generate(listOf(localChanges)).forEach { (bundle, localChangeTokens) ->
      try {
        val response = r4DataSource.upload(bundle)
