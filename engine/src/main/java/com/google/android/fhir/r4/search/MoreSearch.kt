...
import com.google.android.fhir.r4.ucumUrl
...
internal suspend fun <R : Resource> Search.execute(database: R4Database): List<R> {
  return database.search(getQuery())
}

internal suspend fun Search.count(database: R4Database): Long {
