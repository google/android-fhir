...
internal data class FhirServices(
  ...
  class Builder(private val context: Context) {
    ...
    private var idGenerationStrategy: IdGenerationStrategy = IdGenerationStrategy.USE_CLIENT
    ...
    internal fun setIdGenerationStrategy(idGenerationStrategy: IdGenerationStrategy) = apply {
