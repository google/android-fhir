      ...
      fhirServices =
        FhirServices.builder(context.applicationContext)
          .apply {
            ...
            setUploadStrategy(configuration.uploadStrategyOption)
...
data class FhirEngineConfiguration(
  ...
  val uploadStrategyOption: UploadStrategyOption = UploadStrategyOption.PUT,
...
enum class UploadStrategyOption {
  PUT,
  POST,
}
