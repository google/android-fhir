...
package com.google.android.fhir.r4.db.impl
...
import com.google.android.fhir.db.impl.DatabaseEncryptionKeyProvider
import com.google.android.fhir.db.impl.SQLCipherSupportHelper
import com.google.android.fhir.db.impl.entities.LocalChangeToken
import com.google.android.fhir.db.impl.entities.ResourceEntity
import com.google.android.fhir.db.impl.entities.SquashedLocalChange
...
import com.google.android.fhir.r4.search.SearchQuery
 ...
 */
internal interface R4Database : Database<Resource>
...
internal class DatabaseImpl(
  ...
  override suspend fun select(type: String, id: String): Resource {
  ...
  override suspend fun selectEntity(type: String, id: String): ResourceEntity {
    return db.withTransaction {
  ...
  companion object {
     ...
     */
    const val UNENCRYPTED_DATABASE_NAME = "r4_resources.db"
     ...
     */
    const val ENCRYPTED_DATABASE_NAME = "r4_resources_encrypted.db"

    @VisibleForTesting const val DATABASE_PASSPHRASE_NAME = "r4FhirEngineDbPassphrase"
  }
}
