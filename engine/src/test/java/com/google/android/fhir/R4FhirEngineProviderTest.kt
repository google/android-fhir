...
import com.google.android.fhir.r4.NetworkConfiguration
...
/** Unit tests for [R4FhirEngineProvider]. */
@RunWith(RobolectricTestRunner::class)
class R4FhirEngineProviderTest {
  private val provider: R4FhirEngineProvider = R4FhirEngineProvider
