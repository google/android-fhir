...
class ResourceIndexerTest {
  ...
  fun index_id() {
    ...
    val resourceIndices = ResourceIndexer.index(patient, FhirConverterForR4Test)
  ...
  fun index_number_integer() {
    ...
    val resourceIndices = ResourceIndexer.index(molecularSequence, FhirConverterForR4Test)
  ...
  fun index_number_decimal() {
    ...
    val resourceIndices = ResourceIndexer.index(riskAssessment, FhirConverterForR4Test)
  ...
  fun index_dateTime_dateTime() {
    ...
    val resourceIndices = ResourceIndexer.index(observation, FhirConverterForR4Test)
  ...
  fun index_token_identifier() {
    ...
    val resourceIndices = ResourceIndexer.index(invoice, FhirConverterForR4Test)
  ...
  fun index_token_Coding() {
    ...
    val resourceIndices = ResourceIndexer.index(encounter, FhirConverterForR4Test)
  ...
  fun index_reference_canonical_type() {
    ...
    val resourceIndices = ResourceIndexer.index(activityDefinition, FhirConverterForR4Test)
  ...
  fun index_reference_uri_type() {
    ...
    val resourceIndices = ResourceIndexer.index(planDefinition, FhirConverterForR4Test)
  ...
  fun index_quantity_money() {
    ...
    val resourceIndices = ResourceIndexer.index(testInvoice, FhirConverterForR4Test)
  ...
  fun index_quantity_quantity_noUnitOrCode() {
    ...
    val resourceIndices = ResourceIndexer.index(substance, FhirConverterForR4Test)
  ...
  fun index_uri() {
    ...
    val resourceIndices = ResourceIndexer.index(device, FhirConverterForR4Test)
  ...
  fun index_position() {
    ...
    val resourceIndices = ResourceIndexer.index(location, FhirConverterForR4Test)
  ...
  fun index_questionnaire() {
    ...
    val resourceIndices = ResourceIndexer.index(testQuestionnaire, FhirConverterForR4Test)
  ...
  fun index_patient() {
    ...
    val resourceIndices = ResourceIndexer.index(testPatient, FhirConverterForR4Test)
  ...
  fun index_location() {
    ...
    val resourceIndices = ResourceIndexer.index(testLocation, FhirConverterForR4Test)
