...
class ResourceIndexerTest {
  ...
  fun index_id() {
    ...
    val resourceIndices = ResourceIndexer.index(patient, r4FhirAdapter)
  ...
  fun index_number_integer() {
    ...
    val resourceIndices = ResourceIndexer.index(molecularSequence, r4FhirAdapter)
  ...
  fun index_number_decimal() {
    ...
    val resourceIndices = ResourceIndexer.index(riskAssessment, r4FhirAdapter)
  ...
  fun index_dateTime_dateTime() {
    ...
    val resourceIndices = ResourceIndexer.index(observation, r4FhirAdapter)
  ...
  fun index_token_identifier() {
    ...
    val resourceIndices = ResourceIndexer.index(invoice, r4FhirAdapter)
  ...
  fun index_token_Coding() {
    ...
    val resourceIndices = ResourceIndexer.index(encounter, r4FhirAdapter)
  ...
  fun index_reference_canonical_type() {
    ...
    val resourceIndices = ResourceIndexer.index(activityDefinition, r4FhirAdapter)
  ...
  fun index_reference_uri_type() {
    ...
    val resourceIndices = ResourceIndexer.index(planDefinition, r4FhirAdapter)
  ...
  fun index_quantity_money() {
    ...
    val resourceIndices = ResourceIndexer.index(testInvoice, r4FhirAdapter)
  ...
  fun index_quantity_quantity_noUnitOrCode() {
    ...
    val resourceIndices = ResourceIndexer.index(substance, r4FhirAdapter)
  ...
  fun index_uri() {
    ...
    val resourceIndices = ResourceIndexer.index(device, r4FhirAdapter)
  ...
  fun index_position() {
    ...
    val resourceIndices = ResourceIndexer.index(location, r4FhirAdapter)
  ...
  fun index_questionnaire() {
    ...
    val resourceIndices = ResourceIndexer.index(testQuestionnaire, r4FhirAdapter)
  ...
  fun index_patient() {
    ...
    val resourceIndices = ResourceIndexer.index(testPatient, r4FhirAdapter)
  ...
  fun index_location() {
    ...
    val resourceIndices = ResourceIndexer.index(testLocation, r4FhirAdapter)
