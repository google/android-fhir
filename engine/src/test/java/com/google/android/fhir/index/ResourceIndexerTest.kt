...
class ResourceIndexerTest {
  ...
  fun index_id() {
    ...
    val resourceIndices = ResourceIndexer.index(patient, ResourceIndexerManagerForR4Test)
  ...
  fun index_number_integer() {
    ...
    val resourceIndices = ResourceIndexer.index(molecularSequence, ResourceIndexerManagerForR4Test)
  ...
  fun index_number_decimal() {
    ...
    val resourceIndices = ResourceIndexer.index(riskAssessment, ResourceIndexerManagerForR4Test)
  ...
  fun index_dateTime_dateTime() {
    ...
    val resourceIndices = ResourceIndexer.index(observation, ResourceIndexerManagerForR4Test)
  ...
  fun index_token_identifier() {
    ...
    val resourceIndices = ResourceIndexer.index(invoice, ResourceIndexerManagerForR4Test)
  ...
  fun index_token_Coding() {
    ...
    val resourceIndices = ResourceIndexer.index(encounter, ResourceIndexerManagerForR4Test)
  ...
  fun index_reference_canonical_type() {
    ...
    val resourceIndices = ResourceIndexer.index(activityDefinition, ResourceIndexerManagerForR4Test)
  ...
  fun index_reference_uri_type() {
    ...
    val resourceIndices = ResourceIndexer.index(planDefinition, ResourceIndexerManagerForR4Test)
  ...
  fun index_quantity_quantity_noUnitOrCode() {
    ...
    val resourceIndices = ResourceIndexer.index(substance, ResourceIndexerManagerForR4Test)
  ...
  fun index_uri() {
    ...
    val resourceIndices = ResourceIndexer.index(device, ResourceIndexerManagerForR4Test)
